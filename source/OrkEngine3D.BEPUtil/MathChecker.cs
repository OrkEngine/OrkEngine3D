...
namespace BEPUutilities
{
    ...
    public static class MathChecker
    {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this OrkEngine3D.Mathematics.Vector3 v)
        {
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this OrkEngine3D.Mathematics.Matrix4x4 m)
        {
            m.GetRight().Validate();
            m.GetUp().Validate();
        ...
        /// </summary>
        [Conditional("CHECKMATH")]
        public static void Validate(this OrkEngine3D.Mathematics.Quaternion q)
        {
