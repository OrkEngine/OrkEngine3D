...
namespace BEPUutilities
{
    ...
    public struct AffineTransform
    {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 Translation;
        /// <summary>
        ...
        public AffineTransform(OrkEngine3D.Mathematics.Vector3 translation)
        {
        ...
        ///<param name="translation">Translation to use in the transform.</param>
        public AffineTransform(OrkEngine3D.Mathematics.Quaternion orientation, OrkEngine3D.Mathematics.Vector3 translation)
        {
        ...
        public AffineTransform(OrkEngine3D.Mathematics.Vector3 scaling, OrkEngine3D.Mathematics.Quaternion orientation, OrkEngine3D.Mathematics.Vector3 translation)
        {
        ...
        public AffineTransform(Matrix3x3 linearTransform, OrkEngine3D.Mathematics.Vector3 translation)
        {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Matrix4x4 Matrix
        {
            get
            {
        ...
        public static AffineTransform Identity
        {
            get
            {
                var t = new AffineTransform { LinearTransform = Matrix3x3.Identity, Translation = new OrkEngine3D.Mathematics.Vector3() };
                return t;
            }
        }
        ...
        public static void Transform(ref OrkEngine3D.Mathematics.Vector3 position, ref AffineTransform transform, out OrkEngine3D.Mathematics.Vector3 transformed)
        {
        ...
        ///<param name="transformed">Transformed position.</param>
        public static void TransformInverse(ref OrkEngine3D.Mathematics.Vector3 position, ref AffineTransform transform, out OrkEngine3D.Mathematics.Vector3 transformed)
        {
            Vector3Ex.Subtract(ref position, ref transform.Translation, out transformed);
            Matrix3x3 inverse;
        ...
        public static void Invert(ref AffineTransform transform, out AffineTransform inverse)
        {
            ...
            Vector3Ex.Negate(ref inverse.Translation, out inverse.Translation);
        }
        ...
        public static void Multiply(ref AffineTransform a, ref AffineTransform b, out AffineTransform transform)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 translation;
        ...
        public static OrkEngine3D.Mathematics.Vector3 Transform(OrkEngine3D.Mathematics.Vector3 position, AffineTransform affineTransform)
        {
