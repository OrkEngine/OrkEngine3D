...
namespace BEPUutilities
{
    ...
    {
        public static void Add(ref OrkEngine3D.Mathematics.Quaternion a, ref OrkEngine3D.Mathematics.Quaternion b, out OrkEngine3D.Mathematics.Quaternion result)
        {
            result.X = a.X + b.X;
            result.Y = a.Y + b.Y;
            result.Z = a.Z + b.Z;
        ...
        public static void Multiply(ref OrkEngine3D.Mathematics.Quaternion a, ref OrkEngine3D.Mathematics.Quaternion b, out OrkEngine3D.Mathematics.Quaternion result)
        {
            float x = a.X;
            float y = a.Y;
            float z = a.Z;
        ...
        /// Scales a quaternion.
        /// </summary>
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion to multiply.</param>
        /// <param name="scale">Amount to multiply each component of the quaternion by.</param>
        /// <param name="result">Scaled quaternion.</param>
        public static void Multiply(ref OrkEngine3D.Mathematics.Quaternion q, float scale, out OrkEngine3D.Mathematics.Quaternion result)
        {
            result.X = q.X * scale;
            result.Y = q.Y * scale;
            result.Z = q.Z * scale;
        ...
        /// <param name="b">Second quaternion to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Concatenate(ref OrkEngine3D.Mathematics.Quaternion a, ref OrkEngine3D.Mathematics.Quaternion b, out OrkEngine3D.Mathematics.Quaternion result)
        {
            float aX = a.X;
            float aY = a.Y;
            float aZ = a.Z;
        ...
        public static OrkEngine3D.Mathematics.Quaternion Concatenate(OrkEngine3D.Mathematics.Quaternion a, OrkEngine3D.Mathematics.Quaternion b)
        {
            OrkEngine3D.Mathematics.Quaternion result;
            Concatenate(ref a, ref b, out result);
            return result;
        }

        /// <summary>
        /// OrkEngine3D.Mathematics.Quaternion representing the identity transform.
        /// </summary>
        public static OrkEngine3D.Mathematics.Quaternion Identity
        {
            get
            {
                return new OrkEngine3D.Mathematics.Quaternion(0, 0, 0, 1);
            }
        }
        ...
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion based on the rotation matrix.</param>
        public static void CreateFromRotationMatrix(ref Matrix3x3 r, out OrkEngine3D.Mathematics.Quaternion q)
        {
            float trace = r.M11 + r.M22 + r.M33;
#if !WINDOWS
            q = new OrkEngine3D.Mathematics.Quaternion();
#endif
            if (trace >= 0)
            {
        ...
        /// <returns>OrkEngine3D.Mathematics.Quaternion representing the same rotation as the matrix.</returns>
        public static OrkEngine3D.Mathematics.Quaternion CreateFromRotationMatrix(Matrix3x3 r)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
        ...
        /// <param name="r">Rotation matrix to create the quaternion from.</param>
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion based on the rotation matrix.</param>
        public static void CreateFromRotationMatrix(ref OrkEngine3D.Mathematics.Matrix4x4 r, out OrkEngine3D.Mathematics.Quaternion q)
        {
        ...
        /// <param name="r">Rotation matrix used to create a new quaternion.</param>
        /// <returns>OrkEngine3D.Mathematics.Quaternion representing the same rotation as the matrix.</returns>
        public static OrkEngine3D.Mathematics.Quaternion CreateFromRotationMatrix(OrkEngine3D.Mathematics.Matrix4x4 r)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
            CreateFromRotationMatrix(ref r, out toReturn);
            return toReturn;
        ...
        /// </summary>
        /// <param name="quaternion">OrkEngine3D.Mathematics.Quaternion to normalize.</param>
        /// <returns>Normalized quaternion.</returns>
        public static OrkEngine3D.Mathematics.Quaternion Normalize(OrkEngine3D.Mathematics.Quaternion quaternion)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
        ...
        public static void Normalize(ref OrkEngine3D.Mathematics.Quaternion quaternion, out OrkEngine3D.Mathematics.Quaternion toReturn)
        {
        ...
        public static void Slerp(ref OrkEngine3D.Mathematics.Quaternion start, ref OrkEngine3D.Mathematics.Quaternion end, float interpolationAmount, out OrkEngine3D.Mathematics.Quaternion result)
        {
        ...
        public static OrkEngine3D.Mathematics.Quaternion Slerp(OrkEngine3D.Mathematics.Quaternion start, OrkEngine3D.Mathematics.Quaternion end, float interpolationAmount)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
        ...
        /// </summary>
        /// <param name="quaternion">OrkEngine3D.Mathematics.Quaternion to conjugate.</param>
        /// <param name="result">Conjugated quaternion.</param>
        public static void Conjugate(ref OrkEngine3D.Mathematics.Quaternion quaternion, out OrkEngine3D.Mathematics.Quaternion result)
        {
        ...
        public static OrkEngine3D.Mathematics.Quaternion Conjugate(OrkEngine3D.Mathematics.Quaternion quaternion)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
        ...
        /// </summary>
        /// <param name="quaternion">OrkEngine3D.Mathematics.Quaternion to invert.</param>
        /// <param name="result">Result of the inversion.</param>
        public static void Inverse(ref OrkEngine3D.Mathematics.Quaternion quaternion, out OrkEngine3D.Mathematics.Quaternion result)
        {
        ...
        public static OrkEngine3D.Mathematics.Quaternion Inverse(OrkEngine3D.Mathematics.Quaternion quaternion)
        {
            OrkEngine3D.Mathematics.Quaternion result;
        ...
        public static void Transform(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Quaternion rotation, out OrkEngine3D.Mathematics.Vector3 result)
        {
        ...
        public static OrkEngine3D.Mathematics.Vector3 Transform(OrkEngine3D.Mathematics.Vector3 v, OrkEngine3D.Mathematics.Quaternion rotation)
        {
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformX(float x, ref OrkEngine3D.Mathematics.Quaternion rotation, out OrkEngine3D.Mathematics.Vector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformY(float y, ref OrkEngine3D.Mathematics.Quaternion rotation, out OrkEngine3D.Mathematics.Vector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        /// <param name="rotation">Rotation to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformZ(float z, ref OrkEngine3D.Mathematics.Quaternion rotation, out OrkEngine3D.Mathematics.Vector3 result)
        {
            //This operation is an optimized-down version of v' = q * v * q^-1.
            //The expanded form would be to treat v as an 'axis only' quaternion
            //and perform standard quaternion multiplication.  Assuming q is normalized,
        ...
        /// <returns>OrkEngine3D.Mathematics.Quaternion representing the axis and angle rotation.</returns>
        public static OrkEngine3D.Mathematics.Quaternion CreateFromAxisAngle(OrkEngine3D.Mathematics.Vector3 axis, float angle)
        {
            float halfAngle = angle * .5f;
            float s = (float)Math.Sin(halfAngle);
            OrkEngine3D.Mathematics.Quaternion q;
            q.X = axis.X * s;
            q.Y = axis.Y * s;
            q.Z = axis.Z * s;
        ...
        /// <param name="axis">Axis of rotation.</param>
        /// <param name="angle">Angle to rotate around the axis.</param>
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion representing the axis and angle rotation.</param>
        public static void CreateFromAxisAngle(ref OrkEngine3D.Mathematics.Vector3 axis, float angle, out OrkEngine3D.Mathematics.Quaternion q)
        {
            float halfAngle = angle * .5f;
            float s = (float)Math.Sin(halfAngle);
            q.X = axis.X * s;
        ...
        /// <returns>OrkEngine3D.Mathematics.Quaternion representing the yaw, pitch, and roll.</returns>
        public static OrkEngine3D.Mathematics.Quaternion CreateFromYawPitchRoll(float yaw, float pitch, float roll)
        {
            OrkEngine3D.Mathematics.Quaternion toReturn;
        ...
        /// <param name="pitch">Pitch of the rotation.</param>
        /// <param name="roll">Roll of the rotation.</param>
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion representing the yaw, pitch, and roll.</param>
        public static void CreateFromYawPitchRoll(float yaw, float pitch, float roll, out OrkEngine3D.Mathematics.Quaternion q)
        {
        ...
        /// </summary>
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion to be converted.</param>
        /// <returns>Angle around the axis represented by the quaternion.</returns>
        public static float GetAngleFromQuaternion(ref OrkEngine3D.Mathematics.Quaternion q)
        {
        ...
        public static void GetAxisAngleFromQuaternion(ref OrkEngine3D.Mathematics.Quaternion q, out OrkEngine3D.Mathematics.Vector3 axis, out float angle)
        {
#if !WINDOWS
            axis = new OrkEngine3D.Mathematics.Vector3();
#endif
            float qx = q.X;
            float qy = q.Y;
            float qz = q.Z;
        ...
        /// <param name="q">OrkEngine3D.Mathematics.Quaternion representing the rotation from v1 to v2.</param>
        public static void GetQuaternionBetweenNormalizedVectors(ref OrkEngine3D.Mathematics.Vector3 v1, ref OrkEngine3D.Mathematics.Vector3 v2, out OrkEngine3D.Mathematics.Quaternion q)
        {
            float dot;
            ...
            if (dot < -0.9999f) //parallel, opposing direction
            {
                ...
                if (absX < absY && absX < absZ)
                    q = new OrkEngine3D.Mathematics.Quaternion(0, -v1.Z, v1.Y, 0);
                else if (absY < absZ)
                    q = new OrkEngine3D.Mathematics.Quaternion(-v1.Z, 0, v1.X, 0);
                else
                    q = new OrkEngine3D.Mathematics.Quaternion(-v1.Y, v1.X, 0, 0);
            }
            else
            {
                OrkEngine3D.Mathematics.Vector3 axis;
                Vector3Ex.Cross(ref v1, ref v2, out axis);
                q = new OrkEngine3D.Mathematics.Quaternion(axis.X, axis.Y, axis.Z, dot + 1);
            }
        ...
        public static void GetRelativeRotation(ref OrkEngine3D.Mathematics.Quaternion start, ref OrkEngine3D.Mathematics.Quaternion end, out OrkEngine3D.Mathematics.Quaternion relative)
        {
            OrkEngine3D.Mathematics.Quaternion startInverse;
        ...
        public static void GetLocalRotation(ref OrkEngine3D.Mathematics.Quaternion rotation, ref OrkEngine3D.Mathematics.Quaternion targetBasis, out OrkEngine3D.Mathematics.Quaternion localRotation)
        {
            OrkEngine3D.Mathematics.Quaternion basisInverse;
