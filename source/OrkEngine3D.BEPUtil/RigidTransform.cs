...
namespace BEPUutilities
{
    ...
    public struct RigidTransform
    {
        ...
        public RigidTransform(OrkEngine3D.Mathematics.Vector3 position, OrkEngine3D.Mathematics.Quaternion orientation)
        {
            Position = position;
        ...
        ///</summary>
        ///<param name="position">Translation component of the transform.</param>
        public RigidTransform(OrkEngine3D.Mathematics.Vector3 position)
        {
            Position = position;
            Orientation = OrkEngine3D.Mathematics.Quaternion.Identity;
        }
        ...
        public RigidTransform(OrkEngine3D.Mathematics.Quaternion orienation)
        {
        ...
        public static RigidTransform Identity
        {
            get
            {
                var t = new RigidTransform {Orientation = OrkEngine3D.Mathematics.Quaternion.Identity, Position = new OrkEngine3D.Mathematics.Vector3()};
                return t;
            }
        }
        ...
        public static void Transform(ref OrkEngine3D.Mathematics.Vector3 position, ref RigidTransform transform, out OrkEngine3D.Mathematics.Vector3 result)
        {
            OrkEngine3D.Mathematics.Vector3 intermediate;
        ...
        ///<param name="result">Transformed position.</param>
        public static void TransformByInverse(ref OrkEngine3D.Mathematics.Vector3 position, ref RigidTransform transform, out OrkEngine3D.Mathematics.Vector3 result)
        {
