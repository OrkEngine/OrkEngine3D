...
namespace BEPUutilities
{
    public static partial class ConvexHullHelper
    {
        ...
        public static void RemoveRedundantPoints(IList<OrkEngine3D.Mathematics.Vector3> points)
        {
        ...
        public static void RemoveRedundantPoints(IList<OrkEngine3D.Mathematics.Vector3> points, double cellSize)
        {
        ...
        /// </summary>
        /// <param name="points">List of points to prune.</param>
        public static void RemoveRedundantPoints(RawList<OrkEngine3D.Mathematics.Vector3> points)
        {
            RemoveRedundantPoints(points, .001);
        }
        ...
        /// <param name="points">List of points to prune.</param>
        /// <param name="cellSize">Size of cells to determine redundancy.</param>
        public static void RemoveRedundantPoints(RawList<OrkEngine3D.Mathematics.Vector3> points, double cellSize)
        {
