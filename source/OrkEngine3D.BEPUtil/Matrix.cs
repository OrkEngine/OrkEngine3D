...
namespace BEPUutilities
{
    ...
    public static class Matrix4x4Ex
    {
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetBackward(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
        ...
        /// Gets or sets the backward vector of the matrix.
        /// </summary>
        public static void SetBackward(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
            mat.M31 = value.X;
            mat.M32 = value.Y;
            mat.M33 = value.Z;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetDown(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
            OrkEngine3D.Mathematics.Vector3 vector;
            vector.X = -mat.M21;
            vector.Y = -mat.M22;
        ...
        /// Gets or sets the down vector of the matrix.
        /// </summary>
        public static void SetDown(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
            mat.M21 = -value.X;
            mat.M22 = -value.Y;
            mat.M23 = -value.Z;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetForward(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
            OrkEngine3D.Mathematics.Vector3 vector;
            vector.X = -mat.M31;
            vector.Y = -mat.M32;
        ...
        /// Gets or sets the forward vector of the matrix.
        /// </summary>
        public static void SetForward(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
            mat.M31 = -value.X;
            mat.M32 = -value.Y;
            mat.M33 = -value.Z;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetLeft(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
            OrkEngine3D.Mathematics.Vector3 vector;
            vector.X = -mat.M11;
            vector.Y = -mat.M12;
        ...
        /// Gets or sets the left vector of the matrix.
        /// </summary>
        public static void SetLeft(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
            mat.M11 = -value.X;
            mat.M12 = -value.Y;
            mat.M13 = -value.Z;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetRight(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
            OrkEngine3D.Mathematics.Vector3 vector;
            vector.X = mat.M11;
            vector.Y = mat.M12;
        ...
        /// Gets or sets the right vector of the matrix.
        /// </summary>
        public static void SetRight(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
            mat.M11 = value.X;
            mat.M12 = value.Y;
            mat.M13 = value.Z;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Vector3 GetUp(this OrkEngine3D.Mathematics.Matrix4x4 mat)
        {
                OrkEngine3D.Mathematics.Vector3 vector;
                vector.X = mat.M21;
                vector.Y = mat.M22;
        ...
        /// Gets or sets the up vector of the matrix.
        /// </summary>
        public static void SetUp(this OrkEngine3D.Mathematics.Matrix4x4 mat, OrkEngine3D.Mathematics.Vector3 value)
        {
                mat.M21 = value.X;
                mat.M22 = value.Y;
                mat.M23 = value.Z;
        ...
        /// <returns>OrkEngine3D.Mathematics.Matrix4x4 created from the axis and angle.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateFromAxisAngle(OrkEngine3D.Mathematics.Vector3 axis, float angle)
        {
        ...
        /// <param name="axis">Axis around which to rotate.</param>
        /// <param name="angle">Angle to rotate around the axis.</param>
        /// <param name="result">OrkEngine3D.Mathematics.Matrix4x4 created from the axis and angle.</param>
        public static void CreateFromAxisAngle(ref OrkEngine3D.Mathematics.Vector3 axis, float angle, out OrkEngine3D.Mathematics.Matrix4x4 result)
        {
        ...
        /// </summary>
        /// <param name="quaternion">OrkEngine3D.Mathematics.Quaternion to convert.</param>
        /// <param name="result">Rotation matrix created from the quaternion.</param>
        public static void CreateFromQuaternion(ref OrkEngine3D.Mathematics.Quaternion quaternion, out OrkEngine3D.Mathematics.Matrix4x4 result)
        {
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateFromQuaternion(OrkEngine3D.Mathematics.Quaternion quaternion)
        {
            OrkEngine3D.Mathematics.Matrix4x4 toReturn;
        ...
        public static void Multiply(ref OrkEngine3D.Mathematics.Matrix4x4 a, ref OrkEngine3D.Mathematics.Matrix4x4 b, out OrkEngine3D.Mathematics.Matrix4x4 result)
        {
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 Multiply(OrkEngine3D.Mathematics.Matrix4x4 a, OrkEngine3D.Mathematics.Matrix4x4 b)
        {
            OrkEngine3D.Mathematics.Matrix4x4 result;
        ...
        public static void Multiply(ref OrkEngine3D.Mathematics.Matrix4x4 matrix, float scale, out OrkEngine3D.Mathematics.Matrix4x4 result)
        {
        ...
        public static void Transform(ref OrkEngine3D.Mathematics.Vector4 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector4 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        public static OrkEngine3D.Mathematics.Vector4 Transform(OrkEngine3D.Mathematics.Vector4 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
            OrkEngine3D.Mathematics.Vector4 toReturn;
        ...
        /// <param name="result">Transformed vector.</param>
        public static void TransformTranspose(ref OrkEngine3D.Mathematics.Vector4 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector4 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <returns>Transformed vector.</returns>
        public static OrkEngine3D.Mathematics.Vector4 TransformTranspose(OrkEngine3D.Mathematics.Vector4 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
            OrkEngine3D.Mathematics.Vector4 toReturn;
        ...
        /// <param name="matrix">Transform to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void Transform(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector4 result)
        {
        ...
        /// <param name="matrix">Transform to apply to the vector.</param>
        /// <returns>Transformed vector.</returns>
        public static OrkEngine3D.Mathematics.Vector4 Transform(OrkEngine3D.Mathematics.Vector3 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
            OrkEngine3D.Mathematics.Vector4 toReturn;
            Transform(ref v, ref matrix, out toReturn);
            return toReturn;
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformTranspose(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector4 result)
        {
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <returns>Transformed vector.</returns>
        public static OrkEngine3D.Mathematics.Vector4 TransformTranspose(OrkEngine3D.Mathematics.Vector3 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
            OrkEngine3D.Mathematics.Vector4 toReturn;
            TransformTranspose(ref v, ref matrix, out toReturn);
            return toReturn;
        ...
        /// <param name="matrix">Transform to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void Transform(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformTranspose(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">Transform to apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformNormal(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">Transform to apply to the vector.</param>
        /// <returns>Transformed vector.</returns>
        public static OrkEngine3D.Mathematics.Vector3 TransformNormal(OrkEngine3D.Mathematics.Vector3 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <param name="result">Transformed vector.</param>
        public static void TransformNormalTranspose(ref OrkEngine3D.Mathematics.Vector3 v, ref OrkEngine3D.Mathematics.Matrix4x4 matrix, out OrkEngine3D.Mathematics.Vector3 result)
        {
            float vX = v.X;
            float vY = v.Y;
            float vZ = v.Z;
        ...
        /// <param name="matrix">Transform to tranpose and apply to the vector.</param>
        /// <returns>Transformed vector.</returns>
        public static OrkEngine3D.Mathematics.Vector3 TransformNormalTranspose(OrkEngine3D.Mathematics.Vector3 v, OrkEngine3D.Mathematics.Matrix4x4 matrix)
        {
            OrkEngine3D.Mathematics.Vector3 toReturn;
            TransformTranspose(ref v, ref matrix, out toReturn);
            return toReturn;
        ...
        /// </summary>
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to transpose.</param>
        /// <param name="transposed">OrkEngine3D.Mathematics.Matrix4x4 to transpose.</param>
        public static void Transpose(ref OrkEngine3D.Mathematics.Matrix4x4 m, out OrkEngine3D.Mathematics.Matrix4x4 transposed)
        {
        ...
        /// Inverts the matrix.
        /// </summary>
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to invert.</param>
        /// <param name="inverted">Inverted version of the matrix.</param>
        public static void Invert(ref OrkEngine3D.Mathematics.Matrix4x4 m, out OrkEngine3D.Mathematics.Matrix4x4 inverted)
        {
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 Invert(OrkEngine3D.Mathematics.Matrix4x4 m)
        {
            OrkEngine3D.Mathematics.Matrix4x4 inverted;
        ...
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to invert.</param>
        /// <param name="inverted">Inverted version of the matrix.</param>
        public static void InvertAffine(ref OrkEngine3D.Mathematics.Matrix4x4 m, out OrkEngine3D.Mathematics.Matrix4x4 inverted)
        {
        ...
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to invert.</param>
        /// <returns>Inverted version of the matrix.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 InvertAffine(OrkEngine3D.Mathematics.Matrix4x4 m)
        {
            OrkEngine3D.Mathematics.Matrix4x4 inverted;
        ...
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to invert.</param>
        /// <param name="inverted">Inverted version of the matrix.</param>
        public static void InvertRigid(ref OrkEngine3D.Mathematics.Matrix4x4 m, out OrkEngine3D.Mathematics.Matrix4x4 inverted)
        {
        ...
        /// <param name="m">OrkEngine3D.Mathematics.Matrix4x4 to invert.</param>
        /// <returns>Inverted version of the matrix.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 InvertRigid(OrkEngine3D.Mathematics.Matrix4x4 m)
        {
            OrkEngine3D.Mathematics.Matrix4x4 inverse;
        ...
        /// </summary>
        public static OrkEngine3D.Mathematics.Matrix4x4 Identity
        {
            get
            {
                OrkEngine3D.Mathematics.Matrix4x4 toReturn;
        ...
        public static void CreateOrthographicRH(float left, float right, float bottom, float top, float zNear, float zFar, out OrkEngine3D.Mathematics.Matrix4x4 projection)
        {
        ...
        public static void CreatePerspectiveFieldOfViewRH(float fieldOfView, float aspectRatio, float nearClip, float farClip, out OrkEngine3D.Mathematics.Matrix4x4 perspective)
        {
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 CreatePerspectiveFieldOfViewRH(float fieldOfView, float aspectRatio, float nearClip, float farClip)
        {
            OrkEngine3D.Mathematics.Matrix4x4 perspective;
        ...
        /// <param name="viewOrkEngine3D.Mathematics.Matrix4x4">Look at matrix.</param>
        public static void CreateLookAtRH(ref OrkEngine3D.Mathematics.Vector3 position, ref OrkEngine3D.Mathematics.Vector3 target, ref OrkEngine3D.Mathematics.Vector3 upVector, out OrkEngine3D.Mathematics.Matrix4x4 viewSystemMatrix4x4)
        {
            OrkEngine3D.Mathematics.Vector3 forward;
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateLookAtRH(OrkEngine3D.Mathematics.Vector3 position, OrkEngine3D.Mathematics.Vector3 target, OrkEngine3D.Mathematics.Vector3 upVector)
        {
            OrkEngine3D.Mathematics.Matrix4x4 lookAt;
            OrkEngine3D.Mathematics.Vector3 forward;
            Vector3Ex.Subtract(ref target, ref position, out forward);
        ...
        public static void CreateViewRH(ref OrkEngine3D.Mathematics.Vector3 position, ref OrkEngine3D.Mathematics.Vector3 forward, ref OrkEngine3D.Mathematics.Vector3 upVector, out OrkEngine3D.Mathematics.Matrix4x4 viewSystemMatrix4x4)
        {
            ...
            x.Normalize();
            OrkEngine3D.Mathematics.Vector3 y;
        ...
        /// <param name="upVector">Up vector of the camera.</param>
        /// <returns>Look at matrix.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateViewRH(OrkEngine3D.Mathematics.Vector3 position, OrkEngine3D.Mathematics.Vector3 forward, OrkEngine3D.Mathematics.Vector3 upVector)
        {
            OrkEngine3D.Mathematics.Matrix4x4 lookat;
            CreateViewRH(ref position, ref forward, ref upVector, out lookat);
            return lookat;
        ...
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateWorldRH(OrkEngine3D.Mathematics.Vector3 position, OrkEngine3D.Mathematics.Vector3 forward, OrkEngine3D.Mathematics.Vector3 upVector)
        {
            OrkEngine3D.Mathematics.Matrix4x4 lookat;
        ...
        /// <param name="translationOrkEngine3D.Mathematics.Matrix4x4">OrkEngine3D.Mathematics.Matrix4x4 representing the given translation.</param>
        public static void CreateTranslation(ref OrkEngine3D.Mathematics.Vector3 translation, out OrkEngine3D.Mathematics.Matrix4x4 translationSystemMatrix4x4)
        {
            translationSystemMatrix4x4 = new OrkEngine3D.Mathematics.Matrix4x4
            {
                M11 = 1,
                M22 = 1,
                M33 = 1,
        ...
        /// </summary>
        /// <param name="translation">Translation to be represented by the matrix.</param>
        /// <returns>OrkEngine3D.Mathematics.Matrix4x4 representing the given translation.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateTranslation(OrkEngine3D.Mathematics.Vector3 translation)
        {
            OrkEngine3D.Mathematics.Matrix4x4 translationSystemMatrix4x4;
        ...
        /// <param name="scaleOrkEngine3D.Mathematics.Matrix4x4">OrkEngine3D.Mathematics.Matrix4x4 representing the given scale.</param>
        public static void CreateScale(ref OrkEngine3D.Mathematics.Vector3 scale, out OrkEngine3D.Mathematics.Matrix4x4 scaleSystemMatrix4x4)
        {
            scaleSystemMatrix4x4 = new OrkEngine3D.Mathematics.Matrix4x4
                {
                    M11 = scale.X,
                    M22 = scale.Y,
                    M33 = scale.Z,
        ...
        /// </summary>
        /// <param name="scale">Scale to be represented by the matrix.</param>
        /// <returns>OrkEngine3D.Mathematics.Matrix4x4 representing the given scale.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateScale(OrkEngine3D.Mathematics.Vector3 scale)
        {
            OrkEngine3D.Mathematics.Matrix4x4 scaleSystemMatrix4x4;
        ...
        /// <param name="scaleOrkEngine3D.Mathematics.Matrix4x4">OrkEngine3D.Mathematics.Matrix4x4 representing the given scale.</param>
        public static void CreateScale(float x, float y, float z, out OrkEngine3D.Mathematics.Matrix4x4 scaleSystemMatrix4x4)
        {
            scaleSystemMatrix4x4 = new OrkEngine3D.Mathematics.Matrix4x4
            {
                M11 = x,
        ...
        /// <param name="z">Scale along the z axis.</param>
        /// <returns>OrkEngine3D.Mathematics.Matrix4x4 representing the given scale.</returns>
        public static OrkEngine3D.Mathematics.Matrix4x4 CreateScale(float x, float y, float z)
        {
            OrkEngine3D.Mathematics.Matrix4x4 scaleSystemMatrix4x4;
