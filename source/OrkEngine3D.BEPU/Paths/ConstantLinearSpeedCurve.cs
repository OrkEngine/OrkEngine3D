...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class ConstantLinearSpeedCurve : ConstantSpeedCurve<OrkEngine3D.Mathematics.Vector3>
    {
        /// <summary>
        ...
        public ConstantLinearSpeedCurve(float speed, Curve<OrkEngine3D.Mathematics.Vector3> curve)
            : base(speed, curve)
        {
        }
        ...
        public ConstantLinearSpeedCurve(float speed, Curve<OrkEngine3D.Mathematics.Vector3> curve, int sampleCount)
