...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class LinearInterpolationCurve3D : Curve<OrkEngine3D.Mathematics.Vector3>
    {
        /// <summary>
        ...
        //public override void evaluate(double time, out OrkEngine3D.Mathematics.Vector3 value)
        //{
        //    int maxIndex = controlPoints.count - 1;
        //    if (maxIndex == -1)
        //    {
        //        value = OrkEngine3D.Mathematics.Vector3.Zero;
        //        return;
        //    }
        ...
        //    value = Vector3Ex.Lerp(controlPoints[index].value, controlPoints[nextIndex].value, intervalTime); 
