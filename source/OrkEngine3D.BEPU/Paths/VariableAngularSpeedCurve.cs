...
namespace BEPUphysics.Paths
{
    ...
    public class VariableAngularSpeedCurve : VariableSpeedCurve<OrkEngine3D.Mathematics.Quaternion>
    {
        /// <summary>
        ...
        public VariableAngularSpeedCurve(Path<float> speedCurve, Curve<OrkEngine3D.Mathematics.Quaternion> curve)
        ...
        public VariableAngularSpeedCurve(Path<float> speedCurve, Curve<OrkEngine3D.Mathematics.Quaternion> curve, int sampleCount)
