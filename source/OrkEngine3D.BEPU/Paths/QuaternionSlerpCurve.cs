...
namespace BEPUphysics.Paths
{
    ...
    /// </summary>
    public class QuaternionSlerpCurve : Curve<OrkEngine3D.Mathematics.Quaternion>
    {
        /// <summary>
        ...
        public override void Evaluate(int controlPointIndex, float weight, out OrkEngine3D.Mathematics.Quaternion value)
        {
            value = QuaternionEx.Slerp(ControlPoints[controlPointIndex].Value, ControlPoints[controlPointIndex + 1].Value, weight);
        }
        ...
        protected internal override void ControlPointAdded(CurveControlPoint<OrkEngine3D.Mathematics.Quaternion> curveControlPoint, int index)
        {
        }
        ...
        protected internal override void ControlPointRemoved(CurveControlPoint<OrkEngine3D.Mathematics.Quaternion> curveControlPoint, int oldIndex)
        {
        }
        ...
        protected internal override void ControlPointTimeChanged(CurveControlPoint<OrkEngine3D.Mathematics.Quaternion> curveControlPoint, int oldIndex, int newIndex)
        {
        }
        ...
        /// </summary>
        /// <param name="curveControlPoint">Changed control point.</param>
        protected internal override void ControlPointValueChanged(CurveControlPoint<OrkEngine3D.Mathematics.Quaternion> curveControlPoint)
        {
        }
    }
}