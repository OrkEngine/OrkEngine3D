...
namespace BEPUphysics.Paths.PathFollowing
{
    ...
    public class EntityRotator : Updateable, IDuringForcesUpdateable
    {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Quaternion TargetOrientation { get; set; }
        ...
        public static OrkEngine3D.Mathematics.Vector3 GetAngularVelocity(OrkEngine3D.Mathematics.Quaternion start, OrkEngine3D.Mathematics.Quaternion end, float dt)
        {
            //Compute the relative orientation R' between R and the target relative orientation.
            OrkEngine3D.Mathematics.Quaternion errorOrientation;
            QuaternionEx.Conjugate(ref start, out errorOrientation);
            ...
            QuaternionEx.GetAxisAngleFromQuaternion(ref errorOrientation, out axis, out angle);
            Vector3Ex.Multiply(ref axis, angle / dt, out axis);
            return axis;
        }
