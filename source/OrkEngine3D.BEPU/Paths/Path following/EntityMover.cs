...
namespace BEPUphysics.Paths.PathFollowing
{
    ...
    public class EntityMover : Updateable, IDuringForcesUpdateable
    {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 Offset
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 TargetPosition { get; set; }
        ...
        public static OrkEngine3D.Mathematics.Vector3 GetLinearVelocity(OrkEngine3D.Mathematics.Vector3 start, OrkEngine3D.Mathematics.Vector3 end, float dt)
        {
        ...
        void IDuringForcesUpdateable.Update(float dt)
        {
            ...
            else
            {
                ...
                OrkEngine3D.Mathematics.Vector3 worldMovedPoint = Matrix3x3.Transform(LocalOffset, entity.orientationMatrix);
                Vector3Ex.Add(ref worldMovedPoint, ref entity.position, out worldMovedPoint);
