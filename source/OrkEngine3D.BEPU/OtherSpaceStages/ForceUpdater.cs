...
namespace BEPUphysics.OtherSpaceStages
{
    ...
    public class ForceUpdater : MultithreadedProcessingStage
    {
        ...
        protected internal OrkEngine3D.Mathematics.Vector3 gravity;
        ///<summary>
        /// Gets or sets the gravity applied by the force updater.
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 Gravity
        {
            get
            {
                return gravity;
        ...
        internal OrkEngine3D.Mathematics.Vector3 gravityDt;
        ...
        {
            Vector3Ex.Multiply(ref gravity, timeStepSettings.TimeStepDuration, out gravityDt);
