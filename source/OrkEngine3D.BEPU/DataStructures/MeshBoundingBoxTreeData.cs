...
namespace BEPUphysics.DataStructures
{
    ...
    public abstract class MeshBoundingBoxTreeData
    {
        ...
        internal OrkEngine3D.Mathematics.Vector3[] vertices;
        ///<summary>
        /// Gets or sets the vertices of the triangle mesh.
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3[] Vertices
        {
            get
            {
                return vertices;
        ...
        {
            OrkEngine3D.Mathematics.Vector3 v1, v2, v3;
        ...
        public abstract void GetTriangle(int triangleIndex, out OrkEngine3D.Mathematics.Vector3 v1, out OrkEngine3D.Mathematics.Vector3 v2, out OrkEngine3D.Mathematics.Vector3 v3);
        ///<summary>
        ...
        public abstract void GetVertexPosition(int i, out OrkEngine3D.Mathematics.Vector3 vertex);
    }
}
