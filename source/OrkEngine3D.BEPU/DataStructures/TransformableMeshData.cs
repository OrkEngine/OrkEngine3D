...
namespace BEPUphysics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices)
        {
            Vertices = vertices;
            Indices = indices;
        }
        ...
        public TransformableMeshData(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
        ...
        public override void GetTriangle(int triangleIndex, out OrkEngine3D.Mathematics.Vector3 v1, out OrkEngine3D.Mathematics.Vector3 v2, out OrkEngine3D.Mathematics.Vector3 v3)
        {
        ...
        public override void GetVertexPosition(int i, out OrkEngine3D.Mathematics.Vector3 vertex)
        {
