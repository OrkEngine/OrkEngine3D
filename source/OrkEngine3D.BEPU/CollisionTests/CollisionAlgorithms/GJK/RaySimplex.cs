...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct RaySimplex
    {
        ...
        public bool GetPointClosestToOrigin(ref RaySimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        public void GetPointOnSegmentClosestToOrigin(ref RaySimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        public void GetPointOnTriangleClosestToOrigin(ref RaySimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(ref RaySimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        private static bool TryTetrahedronTriangle(ref OrkEngine3D.Mathematics.Vector3 A, ref OrkEngine3D.Mathematics.Vector3 B, ref OrkEngine3D.Mathematics.Vector3 C,
                                                   ref OrkEngine3D.Mathematics.Vector3 simplexA, ref OrkEngine3D.Mathematics.Vector3 simplexB, ref OrkEngine3D.Mathematics.Vector3 simplexC,
                                                   ref OrkEngine3D.Mathematics.Vector3 otherPoint, out RaySimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
            ...
            if (AdotN * ADdotN >= 0)
            {
                ...
                if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 bc;
                    Vector3Ex.Subtract(ref C, ref B, out bc);
                    Vector3Ex.Multiply(ref bc, V, out point);
                    Vector3Ex.Add(ref point, ref B, out point);
                    return true;
                }
        ...
        public void AddNewSimplexPoint(ref OrkEngine3D.Mathematics.Vector3 point, ref OrkEngine3D.Mathematics.Vector3 hitLocation, out RaySimplex shiftedSimplex)
        {
        ...
        public float GetErrorTolerance(ref OrkEngine3D.Mathematics.Vector3 rayOrigin)
        {
            switch (State)
            {
                case SimplexState.Point:
