...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public static class GJKToolbox
    {
        ...
        public static bool AreShapesIntersecting(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 separatingAxis = Toolbox.ZeroVector;
        ...
        public static bool AreShapesIntersecting(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB,
                                                 ref OrkEngine3D.Mathematics.Vector3 localSeparatingAxis)
        {
        ...
        public static bool GetClosestPoints(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB,
                                            out OrkEngine3D.Mathematics.Vector3 closestPointA, out OrkEngine3D.Mathematics.Vector3 closestPointB)
        {
        ...
        ///<returns>Whether or not the objects were intersecting.  If they are intersecting, then the closest points cannot be identified.</returns>
        public static bool GetClosestPoints(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform transformA, ref RigidTransform transformB,
                                            ref CachedSimplex cachedSimplex, out OrkEngine3D.Mathematics.Vector3 closestPointA, out OrkEngine3D.Mathematics.Vector3 closestPointB)
        {
            RigidTransform localtransformB;
            MinkowskiToolbox.GetLocalTransform(ref transformA, ref transformB, out localtransformB);
        ...
        private static bool GetClosestPoints(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB,
                                             ref CachedSimplex cachedSimplex, out OrkEngine3D.Mathematics.Vector3 localClosestPointA, out OrkEngine3D.Mathematics.Vector3 localClosestPointB)
        {
                                   ...
                                   out RayHit hit)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 extremePointToRayOrigin, extremePoint;
            hit.T = 0;
            hit.Location = ray.Position;
            hit.Normal = Toolbox.ZeroVector;
            OrkEngine3D.Mathematics.Vector3 closestOffset = hit.Location;
        ...
        public static bool ConvexCast(ConvexShape sweptShape, ConvexShape target, ref OrkEngine3D.Mathematics.Vector3 sweep, ref RigidTransform startingSweptTransform, ref RigidTransform targetTransform,
                                  out RayHit hit)
        {
        ...
        public static bool ConvexCast(ConvexShape shapeA, ConvexShape shapeB, ref OrkEngine3D.Mathematics.Vector3 sweepA, ref OrkEngine3D.Mathematics.Vector3 sweepB, ref RigidTransform transformA, ref RigidTransform transformB,
                                  out RayHit hit)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 w, p;
            hit.T = 0;
            hit.Location = OrkEngine3D.Mathematics.Vector3.Zero; //The ray starts at the origin.
            hit.Normal = Toolbox.ZeroVector;
            OrkEngine3D.Mathematics.Vector3 v = hit.Location;
