...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct CachedSimplex
    {
        ...
        //    OrkEngine3D.Mathematics.Vector3 direction;
        //    Vector3Ex.Negate(ref localTransformB.Position, out direction);
        //    OrkEngine3D.Mathematics.Quaternion conjugate;
        //    QuaternionEx.Conjugate(ref localTransformB.Orientation, out conjugate);
        //    OrkEngine3D.Mathematics.Vector3.Transform(ref direction, ref conjugate, out direction);
    ...
    {
        public OrkEngine3D.Mathematics.Vector3 A;
        public OrkEngine3D.Mathematics.Vector3 B;
        public OrkEngine3D.Mathematics.Vector3 C;
        public OrkEngine3D.Mathematics.Vector3 D;
    }
    ...
    public struct PairSimplex
    {
        ...
        private PairSimplex(ref RigidTransform localTransformB)
        {
            ...
            Vector3Ex.Negate(ref localTransformB.Position, out A);
            B = new OrkEngine3D.Mathematics.Vector3();
            C = new OrkEngine3D.Mathematics.Vector3();
            D = new OrkEngine3D.Mathematics.Vector3();
            U = 0;
            V = 0;
            W = 0;
        }
        ...
        public PairSimplex(ref CachedSimplex cachedSimplex, ref RigidTransform localTransformB)
        {
            ...
            switch (State)
            {
                case SimplexState.Point:
                    QuaternionEx.Transform(ref cachedSimplex.LocalSimplexB.A, ref LocalTransformB.Orientation, out SimplexB.A);
                    Vector3Ex.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);

                    Vector3Ex.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    B = new OrkEngine3D.Mathematics.Vector3();
                    C = new OrkEngine3D.Mathematics.Vector3();
                    D = new OrkEngine3D.Mathematics.Vector3();
                    break;
                case SimplexState.Segment:
                    ...
                    Vector3Ex.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3Ex.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);

                    Vector3Ex.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3Ex.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    C = new OrkEngine3D.Mathematics.Vector3();
                    D = new OrkEngine3D.Mathematics.Vector3();

                    ////Test for degeneracy.
                    //float edgeLengthAB;
                    //Vector3Ex.DistanceSquared(ref A, ref B, out edgeLengthAB);
                ...
                case SimplexState.Triangle:
                    ...
                    Vector3Ex.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3Ex.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    Vector3Ex.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);

                    Vector3Ex.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3Ex.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3Ex.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    D = new OrkEngine3D.Mathematics.Vector3();
                    ...
                    //Vector3Ex.Cross(ref AB, ref AC, out cross);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    Vector3Ex.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    Vector3Ex.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);
                    Vector3Ex.Add(ref SimplexB.D, ref LocalTransformB.Position, out SimplexB.D);

                    Vector3Ex.Subtract(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3Ex.Subtract(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3Ex.Subtract(ref SimplexA.C, ref SimplexB.C, out C);
                    Vector3Ex.Subtract(ref SimplexA.D, ref SimplexB.D, out D);

                    ////Test for degeneracy.
                    //OrkEngine3D.Mathematics.Vector3 AD;
                    //Vector3Ex.Subtract(ref B, ref A, out AB);
                    //Vector3Ex.Subtract(ref C, ref A, out AC);
                    //Vector3Ex.Subtract(ref D, ref A, out AD);
                    //Vector3Ex.Cross(ref AB, ref AC, out cross);
                    //float volume;
                    //Vector3Ex.Dot(ref cross, ref AD, out volume);
                    ...
                    break;
                default:
                    A = new OrkEngine3D.Mathematics.Vector3();
                    B = new OrkEngine3D.Mathematics.Vector3();
                    C = new OrkEngine3D.Mathematics.Vector3();
                    D = new OrkEngine3D.Mathematics.Vector3();
                    break;
        ...
        public void UpdateCachedSimplex(ref CachedSimplex simplex)
        {
            ...
            {
                case SimplexState.Point:
                    Vector3Ex.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    OrkEngine3D.Mathematics.Quaternion conjugate;
                    QuaternionEx.Conjugate(ref LocalTransformB.Orientation, out conjugate);
                    QuaternionEx.Transform(ref simplex.LocalSimplexB.A, ref conjugate, out simplex.LocalSimplexB.A);
                    break;
                case SimplexState.Segment:
                    Vector3Ex.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3Ex.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                ...
                case SimplexState.Triangle:
                    Vector3Ex.Subtract(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3Ex.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3Ex.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                ...
                case SimplexState.Tetrahedron:
                    ...
                    Vector3Ex.Subtract(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3Ex.Subtract(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                    Vector3Ex.Subtract(ref SimplexB.D, ref LocalTransformB.Position, out simplex.LocalSimplexB.D);
        ...
        public bool GetPointClosestToOrigin(out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        public void GetPointOnSegmentClosestToOrigin(out OrkEngine3D.Mathematics.Vector3 point)
        {
            OrkEngine3D.Mathematics.Vector3 segmentDisplacement;
        ...
        ///</summary>
        ///<param name="point">Point closest to origin.</param>
        public void GetPointOnTriangleClosestToOrigin(out OrkEngine3D.Mathematics.Vector3 point)
        {
            OrkEngine3D.Mathematics.Vector3 ab, ac;
            Vector3Ex.Subtract(ref B, ref A, out ab);
            Vector3Ex.Subtract(ref C, ref A, out ac);
            ...
            if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                OrkEngine3D.Mathematics.Vector3 bc;
        ...
        public bool GetPointOnTetrahedronClosestToOrigin(out OrkEngine3D.Mathematics.Vector3 point)
        {
            ...
            point = new OrkEngine3D.Mathematics.Vector3();
            float minimumDistance = float.MaxValue;


            PairSimplex candidate;
            float candidateDistance;
            OrkEngine3D.Mathematics.Vector3 candidatePoint;
        ...
        private static bool TryTetrahedronTriangle(ref OrkEngine3D.Mathematics.Vector3 A, ref OrkEngine3D.Mathematics.Vector3 B, ref OrkEngine3D.Mathematics.Vector3 C,
                                                   ref OrkEngine3D.Mathematics.Vector3 A1, ref OrkEngine3D.Mathematics.Vector3 B1, ref OrkEngine3D.Mathematics.Vector3 C1,
                                                   ref OrkEngine3D.Mathematics.Vector3 A2, ref OrkEngine3D.Mathematics.Vector3 B2, ref OrkEngine3D.Mathematics.Vector3 C2,
                                                   float errorTolerance,
                                                   ref OrkEngine3D.Mathematics.Vector3 otherPoint, out PairSimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
            ...
            Vector3Ex.Subtract(ref B, ref A, out ab);
            Vector3Ex.Subtract(ref C, ref A, out ac);
            OrkEngine3D.Mathematics.Vector3 normal;
            Vector3Ex.Cross(ref ab, ref ac, out normal);
            float AdotN, ADdotN;
            OrkEngine3D.Mathematics.Vector3 AD;
            Vector3Ex.Subtract(ref otherPoint, ref A, out AD);
            ...
            if (AdotN * ADdotN >= -Toolbox.Epsilon * errorTolerance)
            {
                ...
                if (vc <= 0 && AdotAB > 0 && BdotAB < 0) //Note > and < instead of => <=; avoids possibly division by zero
                {
                    ...
                    Vector3Ex.Multiply(ref ab, simplex.V, out point);
                    Vector3Ex.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (vb <= 0f && AdotAC > 0f && CdotAC < 0f) //Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    simplex.U = 1 - simplex.V;
                    Vector3Ex.Multiply(ref ac, simplex.V, out point);
                    Vector3Ex.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 bc;
                    Vector3Ex.Subtract(ref C, ref B, out bc);
                    Vector3Ex.Multiply(ref bc, simplex.V, out point);
                    Vector3Ex.Add(ref point, ref B, out point);
                    return true;
                }
                ...
                Vector3Ex.Multiply(ref ab, simplex.V, out point);
                OrkEngine3D.Mathematics.Vector3 acw;
                Vector3Ex.Multiply(ref ac, simplex.W, out acw);
                Vector3Ex.Add(ref A, ref point, out point);
                Vector3Ex.Add(ref point, ref acw, out point);
                return true;
            }
        ...
        public bool GetNewSimplexPoint(ConvexShape shapeA, ConvexShape shapeB, int iterationCount, ref OrkEngine3D.Mathematics.Vector3 closestPoint)
        {
            OrkEngine3D.Mathematics.Vector3 negativeDirection;
            Vector3Ex.Negate(ref closestPoint, out negativeDirection);
            OrkEngine3D.Mathematics.Vector3 sa, sb;
            ...
            OrkEngine3D.Mathematics.Vector3 S;
        ...
        public void GetClosestPoints(out OrkEngine3D.Mathematics.Vector3 closestPointA, out OrkEngine3D.Mathematics.Vector3 closestPointB)
        {
            //A * U + B * V + C * W
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    ...
                    Vector3Ex.Multiply(ref SimplexA.A, U, out closestPointA);
                    Vector3Ex.Multiply(ref SimplexA.B, V, out temp);
                    Vector3Ex.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3Ex.Multiply(ref SimplexB.A, U, out closestPointB);
                    Vector3Ex.Multiply(ref SimplexB.B, V, out temp);
                    Vector3Ex.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
                case SimplexState.Triangle:
                    Vector3Ex.Multiply(ref SimplexA.A, U, out closestPointA);
                    Vector3Ex.Multiply(ref SimplexA.B, V, out temp);
                    Vector3Ex.Add(ref closestPointA, ref temp, out closestPointA);
                    Vector3Ex.Multiply(ref SimplexA.C, W, out temp);
                    Vector3Ex.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3Ex.Multiply(ref SimplexB.A, U, out closestPointB);
                    Vector3Ex.Multiply(ref SimplexB.B, V, out temp);
                    Vector3Ex.Add(ref closestPointB, ref temp, out closestPointB);
                    Vector3Ex.Multiply(ref SimplexB.C, W, out temp);
                    Vector3Ex.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
            }
