...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    public struct SimpleSimplex
    {
        ...
        private static bool TryTetrahedronTriangle(ref OrkEngine3D.Mathematics.Vector3 A, ref OrkEngine3D.Mathematics.Vector3 B, ref OrkEngine3D.Mathematics.Vector3 C, 
                                                   ref OrkEngine3D.Mathematics.Vector3 otherPoint, out SimpleSimplex simplex, out OrkEngine3D.Mathematics.Vector3 point)
        {
        ...
        public void AddNewSimplexPoint(ref OrkEngine3D.Mathematics.Vector3 point)
        {
            switch (State)
            {
