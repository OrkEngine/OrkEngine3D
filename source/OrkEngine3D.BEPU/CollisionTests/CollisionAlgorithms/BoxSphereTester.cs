...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxSphereTester
    {
        ...
        public static bool AreShapesColliding(BoxShape box, SphereShape sphere, ref RigidTransform boxTransform, ref OrkEngine3D.Mathematics.Vector3 spherePosition, out ContactData contact)
        {
            contact = new ContactData();

            OrkEngine3D.Mathematics.Vector3 localPosition;
            RigidTransform.TransformByInverse(ref spherePosition, ref boxTransform, out localPosition);
#if !WINDOWS
            OrkEngine3D.Mathematics.Vector3 localClosestPoint = new OrkEngine3D.Mathematics.Vector3();
#else
            OrkEngine3D.Mathematics.Vector3 localClosestPoint;
#endif
            ...
            {
                //Inside of the box.
                OrkEngine3D.Mathematics.Vector3 penetrationDepths;
