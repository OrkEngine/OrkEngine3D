...
namespace BEPUphysics.CollisionTests.Manifolds
{
    ...
    public abstract class MobileMeshContactManifold : TriangleMeshConvexContactManifold
    {
        ...
        protected internal override int FindOverlappingTriangles(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 transformedVelocity;
            ...
            if (convex.entity != null)
                ...
                transformedVelocity = new OrkEngine3D.Mathematics.Vector3();
            if (mesh.entity != null)
                Vector3Ex.Subtract(ref transformedVelocity, ref mesh.entity.linearVelocity, out transformedVelocity);
            ...
            Vector3Ex.Multiply(ref transformedVelocity, dt, out transformedVelocity);
        ...
        float previousDepth;
        OrkEngine3D.Mathematics.Vector3 lastValidConvexPosition;
                ...
                if (mesh.Shape.IsLocalRayOriginInMesh(ref ray, out hit))
                {
                    ...
                    for (int i = 0; i < contacts.Count; i++)
                    {
                        if (contacts.Elements[i].Id == 2)
                        {
                            ...
                            supplementData.Elements[i].LocalOffsetA = new OrkEngine3D.Mathematics.Vector3();
