...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Capsule : Entity<ConvexCollidable<CapsuleShape>>
    {
        ...
        public static void GetCapsuleInformation(ref OrkEngine3D.Mathematics.Vector3 start, ref OrkEngine3D.Mathematics.Vector3 end, out OrkEngine3D.Mathematics.Quaternion orientation, out float length)
        {
        ...
        public Capsule(OrkEngine3D.Mathematics.Vector3 position, float length, float radius, float mass)
        ...
        /// <param name="length">Length of the capsule.</param>
        /// <param name="radius">Radius of the capsule.</param>
        public Capsule(OrkEngine3D.Mathematics.Vector3 position, float length, float radius)
            : this(length, radius)
        {
            Position = position;
        }
