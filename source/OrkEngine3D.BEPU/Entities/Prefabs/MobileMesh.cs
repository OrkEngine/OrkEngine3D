...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MobileMesh : Entity<MobileMeshCollidable>
    {
        ...
        public MobileMesh(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices, AffineTransform localTransform, MobileMeshSolidity solidity)
        {
        ...
        public MobileMesh(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices,  AffineTransform localTransform, MobileMeshSolidity solidity, float mass)
        {
            OrkEngine3D.Mathematics.Vector3 center;
            var shape = new MobileMeshShape(vertices, indices, localTransform, solidity, out center);
