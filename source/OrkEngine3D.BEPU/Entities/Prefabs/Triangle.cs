...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 LocalVertexA
        {
            get
            {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 LocalVertexB
        {
            get
            {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 LocalVertexC
        {
            get
            {
        ...
        public Triangle(OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3, float mass)
        {
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3)
        {
            OrkEngine3D.Mathematics.Vector3 center;
            var shape = new TriangleShape(v1, v2, v3, out center);
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(OrkEngine3D.Mathematics.Vector3 pos, OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3, float mass)
            : this(v1, v2, v3, mass)
        {
            Position = pos;
        }
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(OrkEngine3D.Mathematics.Vector3 pos, OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3)
            : this(v1, v2, v3)
        {
            Position = pos;
        }
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(MotionState motionState, OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3, float mass)
            : this(v1, v2, v3, mass)
        {
        ...
        /// <param name="v2">Position of the second vertex.</param>
        /// <param name="v3">Position of the third vertex.</param>
        public Triangle(MotionState motionState, OrkEngine3D.Mathematics.Vector3 v1, OrkEngine3D.Mathematics.Vector3 v2, OrkEngine3D.Mathematics.Vector3 v3)
            : this(v1, v2, v3)
        {
            MotionState = motionState;
        }
