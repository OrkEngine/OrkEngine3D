...
namespace BEPUphysics.Entities
{
    ...
    {
        internal OrkEngine3D.Mathematics.Vector3 position;
        internal OrkEngine3D.Mathematics.Quaternion orientation = OrkEngine3D.Mathematics.Quaternion.Identity;
        internal Matrix3x3 orientationMatrix = Matrix3x3.Identity;
        internal OrkEngine3D.Mathematics.Vector3 linearVelocity;
        internal OrkEngine3D.Mathematics.Vector3 angularVelocity;
#if CONSERVE
        internal OrkEngine3D.Mathematics.Vector3 angularMomentum;
#endif
        ...
        public OrkEngine3D.Mathematics.Quaternion Orientation
        {
            ...
            set
            {
                QuaternionEx.Normalize(ref value, out orientation);
        ...
        public Matrix3x3 OrientationMatrix
        {
            ...
            set
            {
                QuaternionEx.CreateFromRotationMatrix(ref value, out orientation);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 AngularMomentum
        {
            get
            {
#if CONSERVE
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LinearMomentum
        {
            get
            {
                OrkEngine3D.Mathematics.Vector3 momentum;
                Vector3Ex.Multiply(ref linearVelocity, mass, out momentum);
                return momentum;
            }
            set
            {
                Vector3Ex.Multiply(ref value, inverseMass, out linearVelocity);
                activityInformation.Activate();
        ...
        public void ApplyImpulse(OrkEngine3D.Mathematics.Vector3 location, OrkEngine3D.Mathematics.Vector3 impulse)
        {
        ...
        ///<param name="location">Location to apply the impulse.</param>
        ///<param name="impulse">Impulse to apply.</param>
        public void ApplyImpulse(ref OrkEngine3D.Mathematics.Vector3 location, ref OrkEngine3D.Mathematics.Vector3 impulse)
        {
            if (isDynamic)
            {
                ApplyLinearImpulse(ref impulse);
#if WINDOWS
                OrkEngine3D.Mathematics.Vector3 positionDifference;
#else
                OrkEngine3D.Mathematics.Vector3 positionDifference = new OrkEngine3D.Mathematics.Vector3();
#endif
                ...
                Vector3Ex.Cross(ref positionDifference, ref impulse, out cross);
        ...
        /// </summary>
        /// <param name="impulse">Impulse to apply.</param>
        public void ApplyLinearImpulse(ref OrkEngine3D.Mathematics.Vector3 impulse)
        {
        ...
        /// </summary>
        /// <param name="impulse">Impulse to apply.</param>
        public void ApplyAngularImpulse(ref OrkEngine3D.Mathematics.Vector3 impulse)
        {
        ...
        void IPositionUpdateable.PreUpdatePosition(float dt)
        {
            ...
            var multiplier = new OrkEngine3D.Mathematics.Quaternion(increment.X, increment.Y, increment.Z, 0);
            ...
            orientation = OrkEngine3D.Mathematics.Quaternion.Normalize(orientation);
