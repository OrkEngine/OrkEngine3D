...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshTerrainPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 terrainUp = new OrkEngine3D.Mathematics.Vector3(mesh.worldTransform.LinearTransform.M21, mesh.worldTransform.LinearTransform.M22, mesh.worldTransform.LinearTransform.M23);
            float dot;
            OrkEngine3D.Mathematics.Vector3 AB, AC, normal;
