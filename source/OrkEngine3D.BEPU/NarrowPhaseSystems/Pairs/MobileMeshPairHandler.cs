...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public abstract class MobileMeshPairHandler : StandardPairHandler
    {
        ...
        protected internal override void GetContactInformation(int index, out ContactInformation info)
        {
            ...
            {
                Vector3Ex.Subtract(ref info.Contact.Position, ref mobileMesh.entity.position, out velocity);
                Vector3Ex.Cross(ref mobileMesh.entity.angularVelocity, ref velocity, out velocity);
                Vector3Ex.Add(ref velocity, ref mobileMesh.entity.linearVelocity, out velocity);
