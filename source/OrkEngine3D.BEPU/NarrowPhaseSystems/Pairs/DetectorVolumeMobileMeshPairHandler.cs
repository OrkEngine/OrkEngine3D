...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeMobileMeshPairHandler : DetectorVolumePairHandler
    {
        ...
        public override void UpdateCollision(float dt)
        {
            ...
            mobileTriangleTransform.Orientation = OrkEngine3D.Mathematics.Quaternion.Identity;
            detectorTriangleTransform.Orientation = OrkEngine3D.Mathematics.Quaternion.Identity;
            for (int i = 0; i < meshData.Indices.Length; i += 3)
            {
                ...
                Vector3Ex.Add(ref mobileTriangle.vA, ref mobileTriangle.vB, out mobileTriangleTransform.Position);
                Vector3Ex.Add(ref mobileTriangle.vC, ref mobileTriangleTransform.Position, out mobileTriangleTransform.Position);
                Vector3Ex.Multiply(ref mobileTriangleTransform.Position, 1 / 3f, out mobileTriangleTransform.Position);
                Vector3Ex.Subtract(ref mobileTriangle.vA, ref mobileTriangleTransform.Position, out mobileTriangle.vA);
                Vector3Ex.Subtract(ref mobileTriangle.vB, ref mobileTriangleTransform.Position, out mobileTriangle.vB);
                Vector3Ex.Subtract(ref mobileTriangle.vC, ref mobileTriangleTransform.Position, out mobileTriangle.vC);
                ...
                for (int j = 0; j < overlaps.Count; j++)
                {
                    ...
                    Vector3Ex.Add(ref detectorTriangle.vA, ref detectorTriangle.vB, out detectorTriangleTransform.Position);
                    Vector3Ex.Add(ref detectorTriangle.vC, ref detectorTriangleTransform.Position, out detectorTriangleTransform.Position);
                    Vector3Ex.Multiply(ref detectorTriangleTransform.Position, 1 / 3f, out detectorTriangleTransform.Position);
                    Vector3Ex.Subtract(ref detectorTriangle.vA, ref detectorTriangleTransform.Position, out detectorTriangle.vA);
                    Vector3Ex.Subtract(ref detectorTriangle.vB, ref detectorTriangleTransform.Position, out detectorTriangle.vB);
                    Vector3Ex.Subtract(ref detectorTriangle.vC, ref detectorTriangleTransform.Position, out detectorTriangle.vC);
            ...
            if (mesh.Shape.solidity == MobileMeshSolidity.Solid && !Containing && !Touching)
            {
                ...
                OrkEngine3D.Mathematics.Vector3 vertex;
