...
namespace BEPUphysics.Vehicle
{
    ...
    public class RaycastWheelShape : WheelShape
    {
        ...
        public RaycastWheelShape(float graphicalRadius, OrkEngine3D.Mathematics.Matrix4x4 localGraphicTransform)
        {
        ...
        protected internal override void Initialize()
        {
            ...
            OrkEngine3D.Mathematics.Vector3 startpoint = wheel.suspension.localAttachmentPoint;
            OrkEngine3D.Mathematics.Vector3 endpoint = startpoint + wheel.suspension.localDirection * wheel.suspension.restLength;
            OrkEngine3D.Mathematics.Vector3 min, max;
