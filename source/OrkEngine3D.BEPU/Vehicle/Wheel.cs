...
namespace BEPUphysics.Vehicle
{
    ...
    public class Wheel
    {
        internal OrkEngine3D.Mathematics.Vector3 ra, rb;
        ...
        internal OrkEngine3D.Mathematics.Vector3 localForwardDirection = new OrkEngine3D.Mathematics.Vector3(0, 0, -1);

        internal OrkEngine3D.Mathematics.Vector3 normal;
        ...
        internal OrkEngine3D.Mathematics.Vector3 supportLocation;
        internal Entity supportingEntity;
        internal WheelSuspension suspension;
        internal Vehicle vehicle;
        internal OrkEngine3D.Mathematics.Vector3 worldForwardDirection;
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalForwardDirection
        {
            get { return localForwardDirection; }
            set
            {
                localForwardDirection = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                if (vehicle != null)
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 SupportLocation
        {
        ...
        /// Gets the normal 
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 SupportNormal
        {
            get { return normal; }
        }
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldForwardDirection
        {
            get { return worldForwardDirection; }
            set
            {
                worldForwardDirection = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                if (vehicle != null)
                {
                    OrkEngine3D.Mathematics.Quaternion conjugate;
                    QuaternionEx.Conjugate(ref Vehicle.Body.orientation, out conjugate);
                    QuaternionEx.Transform(ref worldForwardDirection, ref conjugate, out localForwardDirection);
                }
                else
