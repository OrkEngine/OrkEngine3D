...
namespace BEPUphysics.Vehicle
{
    ...
    public abstract class WheelShape : ICollisionRulesOwner
    {
        ...
        /// </summary>
        protected internal Box detector = new Box(OrkEngine3D.Mathematics.Vector3.Zero, 0, 0, 0);

        protected internal OrkEngine3D.Mathematics.Matrix4x4 localGraphicTransform;
        ...
        internal OrkEngine3D.Mathematics.Matrix4x4 steeringTransform;
        protected internal Wheel wheel;

        protected internal OrkEngine3D.Mathematics.Matrix4x4 worldTransform;
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Matrix4x4 LocalGraphicTransform
        {
        ...
        protected internal abstract bool FindSupport(out OrkEngine3D.Mathematics.Vector3 location, out OrkEngine3D.Mathematics.Vector3 normal, out float suspensionLength, out Collidable supportCollidable, out Entity entity, out Material material);
