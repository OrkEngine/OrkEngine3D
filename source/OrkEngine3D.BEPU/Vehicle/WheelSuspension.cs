...
namespace BEPUphysics.Vehicle
{
    ...
    public class WheelSuspension : ISpringSettings, ISolverSettings
    {
        ...
        internal OrkEngine3D.Mathematics.Vector3 localAttachmentPoint;
        internal OrkEngine3D.Mathematics.Vector3 localDirection;
        ...
        private Wheel wheel;
        internal OrkEngine3D.Mathematics.Vector3 worldAttachmentPoint;
        internal OrkEngine3D.Mathematics.Vector3 worldDirection;
        ...
        public WheelSuspension(float stiffnessConstant, float dampingConstant, OrkEngine3D.Mathematics.Vector3 localDirection, float restLength, OrkEngine3D.Mathematics.Vector3 localAttachmentPoint)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalAttachmentPoint
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldAttachmentPoint
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalDirection
        {
            get { return localDirection; }
            set
            {
                localDirection = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldDirection
        {
            get { return worldDirection; }
            set
            {
                worldDirection = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
        ...
        internal void PreStep(float dt)
        {
            ...
            //OrkEngine3D.Mathematics.Vector3.TransformNormal(ref myLocalDirection, ref parentA.myInternalOrientationMatrix, out myWorldDirection);
