...
namespace BEPUphysics.Vehicle
{
    ...
    public class CylinderCastWheelShape : WheelShape
    {
        ...
        private OrkEngine3D.Mathematics.Quaternion localWheelOrientation;
        /// <summary>
        /// Gets or sets the unsteered orientation of the wheel in the vehicle's local space.
        /// </summary>
        public OrkEngine3D.Mathematics.Quaternion LocalWheelOrientation
        {
        ...
        public CylinderCastWheelShape(float radius, float width, OrkEngine3D.Mathematics.Quaternion localWheelOrientation, OrkEngine3D.Mathematics.Matrix4x4 localGraphicTransform, bool includeSteeringTransformInCast)
        {
        ...
        {
#if !WINDOWS
            OrkEngine3D.Mathematics.Vector3 newPosition = new OrkEngine3D.Mathematics.Vector3();
#else
            OrkEngine3D.Mathematics.Vector3 newPosition;
#endif
            OrkEngine3D.Mathematics.Vector3 worldAttachmentPoint;
            OrkEngine3D.Mathematics.Vector3 localAttach;
            ...
            OrkEngine3D.Mathematics.Vector3 worldDirection;
            ...
            OrkEngine3D.Mathematics.Matrix4x4 spinTransform;

            OrkEngine3D.Mathematics.Vector3 localSpinAxis;
            ...
            OrkEngine3D.Mathematics.Matrix4x4 localTurnTransform;
            ...
            //OrkEngine3D.Mathematics.Matrix4x4.Multiply(ref localTurnTransform, ref spinTransform, out localTurnTransform);
        ...
        protected internal override bool FindSupport(out OrkEngine3D.Mathematics.Vector3 location, out OrkEngine3D.Mathematics.Vector3 normal, out float suspensionLength, out Collidable supportingCollidable, out Entity entity, out Material material)
        {
            ...
            OrkEngine3D.Mathematics.Quaternion localSteeringTransform;
            ...
            var startingTransform = new RigidTransform
            {
                ...
                Orientation = QuaternionEx.Concatenate(QuaternionEx.Concatenate(LocalWheelOrientation, IncludeSteeringTransformInCast ? localSteeringTransform : OrkEngine3D.Mathematics.Quaternion.Identity), wheel.vehicle.Body.orientation)
            };
        ...
        protected internal override void UpdateDetectorPosition()
        {
            ...
            OrkEngine3D.Mathematics.Vector3 linearVelocity;
