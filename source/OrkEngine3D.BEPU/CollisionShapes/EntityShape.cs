...
namespace BEPUphysics.CollisionShapes
{
    ...
    public abstract class EntityShape : CollisionShape
    {
        ...
        protected void TransformLocalExtremePoints(ref OrkEngine3D.Mathematics.Vector3 x, ref OrkEngine3D.Mathematics.Vector3 y, ref OrkEngine3D.Mathematics.Vector3 z, ref Matrix3x3 transform, out OrkEngine3D.Mathematics.Vector3 result)
        {
