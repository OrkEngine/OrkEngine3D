...
namespace BEPUphysics.CollisionShapes
{
    ...
    public struct CompoundShapeEntry
    {
        ...
        public CompoundShapeEntry(EntityShape shape, OrkEngine3D.Mathematics.Vector3 position, float weight)
        {
            position.Validate();
        ...
        ///<param name="weight">Weight of the entry.  This defines how much the entry contributes to its owner
        /// for the purposes of center of rotation computation.</param>
        public CompoundShapeEntry(EntityShape shape, OrkEngine3D.Mathematics.Quaternion orientation, float weight)
        {
        ...
        ///<param name="shape">Shape to use.</param>
        ///<param name="position">Local position of the shape.</param>
        public CompoundShapeEntry(EntityShape shape, OrkEngine3D.Mathematics.Vector3 position)
        {
            position.Validate();
            LocalTransform = new RigidTransform(position);
            Shape = shape;
        ...
        ///<param name="shape">Shape to use.</param>
        ///<param name="orientation">Local orientation of the shape.</param>
        public CompoundShapeEntry(EntityShape shape, OrkEngine3D.Mathematics.Quaternion orientation)
        {
            orientation.Validate();
            LocalTransform = new RigidTransform(orientation);
            Shape = shape;
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public CompoundShape(IList<CompoundShapeEntry> shapes, out OrkEngine3D.Mathematics.Vector3 center)
        {
            if (shapes.Count > 0)
            {
                float volume;
        ...
        public static void ComputeVolumeDistribution(IList<CompoundShapeEntry> entries, out float volume, out Matrix3x3 volumeDistribution, out OrkEngine3D.Mathematics.Vector3 center)
        {
            ...
            if (totalWeight <= 0)
                throw new BEPUutilities.NotFiniteNumberException("Cannot compute distribution; the total weight of a compound shape must be positive.");
        ...
        public static void TransformContribution(ref RigidTransform transform, ref OrkEngine3D.Mathematics.Vector3 center, ref Matrix3x3 baseContribution, float weight, out Matrix3x3 contribution)
        {
            Matrix3x3 rotation;
