...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class ConvexHullShape : ConvexShape
    {
        ...
        ///</summary>
        public ReadOnlyList<OrkEngine3D.Mathematics.Vector3> Vertices
        {
            get
            {
                return new ReadOnlyList<OrkEngine3D.Mathematics.Vector3>(vertices);
            }
        }
        OrkEngine3D.Mathematics.Vector3[] vertices;
        ...
        public ConvexHullShape(IList<OrkEngine3D.Mathematics.Vector3> vertices)
        {
            if (vertices.Count == 0)
        ...
        ///<exception cref="ArgumentException">Thrown when the point set is empty.</exception>
        public ConvexHullShape(IList<OrkEngine3D.Mathematics.Vector3> vertices, out OrkEngine3D.Mathematics.Vector3 center)
        {
            if (vertices.Count == 0)
                throw new ArgumentException("Vertices list used to create a ConvexHullShape cannot be empty.");
        ...
        ///<exception cref="ArgumentException">Thrown when the point set is empty.</exception>
        public ConvexHullShape(IList<OrkEngine3D.Mathematics.Vector3> vertices, out OrkEngine3D.Mathematics.Vector3 center, IList<int> outputHullTriangleIndices, IList<OrkEngine3D.Mathematics.Vector3> outputUniqueSurfaceVertices)
        {
            if (vertices.Count == 0)
                throw new ArgumentException("Vertices list used to create a ConvexHullShape cannot be empty.");
            ...
            this.vertices = new OrkEngine3D.Mathematics.Vector3[outputUniqueSurfaceVertices.Count];
        ...
        public ConvexHullShape(IList<OrkEngine3D.Mathematics.Vector3> localSurfaceVertices, ConvexShapeDescription description)
        {
            ...
            vertices = new OrkEngine3D.Mathematics.Vector3[localSurfaceVertices.Count];
        ...
        public static ConvexShapeDescription ComputeDescription(IList<OrkEngine3D.Mathematics.Vector3> vertices, float collisionMargin, out OrkEngine3D.Mathematics.Vector3 center, IList<int> outputHullTriangleIndices, IList<OrkEngine3D.Mathematics.Vector3> outputUniqueSurfaceVertices)
        {
        ...
        public static float ComputeMaximumRadius(IList<OrkEngine3D.Mathematics.Vector3> localSurfaceVertices, float collisionMargin)
        {
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            float minY, maxY;
            float minZ, maxZ;
            var right = new OrkEngine3D.Mathematics.Vector3(o.M11, o.M21, o.M31);
            var up = new OrkEngine3D.Mathematics.Vector3(o.M12, o.M22, o.M32);
            var backward = new OrkEngine3D.Mathematics.Vector3(o.M13, o.M23, o.M33);
            Vector3Ex.Dot(ref vertices[0], ref right, out maxX);
            minX = maxX;
            Vector3Ex.Dot(ref vertices[0], ref up, out maxY);
            minY = maxY;
            Vector3Ex.Dot(ref vertices[0], ref backward, out maxZ);
            minZ = maxZ;
            int minXIndex = 0;
            int maxXIndex = 0;
            int minYIndex = 0;
            ...
            {
                float dot;
                Vector3Ex.Dot(ref vertices[i], ref right, out dot);
                if (dot < minX)
                {
                    minX = dot;
                    minXIndex = i;
                ...
                Vector3Ex.Dot(ref vertices[i], ref up, out dot);
                if (dot < minY)
                {
                    minY = dot;
                    minYIndex = i;
                ...
                Vector3Ex.Dot(ref vertices[i], ref backward, out dot);
                if (dot < minZ)
                {
                    minZ = dot;
                    minZIndex = i;
        ...
        {
            float max;
            Vector3Ex.Dot(ref vertices[0], ref direction, out max);
            int maxIndex = 0;
            for (int i = 1; i < vertices.Length; i++)
            {
                float dot;
                Vector3Ex.Dot(ref vertices[i], ref direction, out dot);
                if (dot > max)
                {
                    max = dot;
                    maxIndex = i;
