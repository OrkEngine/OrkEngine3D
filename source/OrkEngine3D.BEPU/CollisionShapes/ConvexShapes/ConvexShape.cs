...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        public abstract void GetLocalExtremePointWithoutMargin(ref OrkEngine3D.Mathematics.Vector3 direction, out OrkEngine3D.Mathematics.Vector3 extremePoint);
        ...
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePointWithoutMargin(OrkEngine3D.Mathematics.Vector3 direction, ref RigidTransform shapeTransform, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
        ...
        /// <param name="shapeTransform">Transform to use for the shape.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePoint(OrkEngine3D.Mathematics.Vector3 direction, ref RigidTransform shapeTransform, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
        ...
        ///<param name="direction">Direction to find the extreme point in.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetLocalExtremePoint(OrkEngine3D.Mathematics.Vector3 direction, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
            GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 right;
            var direction = new OrkEngine3D.Mathematics.Vector3(o.M11, o.M21, o.M31);
            GetLocalExtremePointWithoutMargin(ref direction, out right);

            OrkEngine3D.Mathematics.Vector3 left;
            direction = new OrkEngine3D.Mathematics.Vector3(-o.M11, -o.M21, -o.M31);
            GetLocalExtremePointWithoutMargin(ref direction, out left);

            OrkEngine3D.Mathematics.Vector3 up;
            direction = new OrkEngine3D.Mathematics.Vector3(o.M12, o.M22, o.M32);
            GetLocalExtremePointWithoutMargin(ref direction, out up);

            OrkEngine3D.Mathematics.Vector3 down;
            direction = new OrkEngine3D.Mathematics.Vector3(-o.M12, -o.M22, -o.M32);
            GetLocalExtremePointWithoutMargin(ref direction, out down);

            OrkEngine3D.Mathematics.Vector3 backward;
            direction = new OrkEngine3D.Mathematics.Vector3(o.M13, o.M23, o.M33);
            ...
            OrkEngine3D.Mathematics.Vector3 positive, negative;
        ...
        public void GetSweptBoundingBox(ref RigidTransform transform, ref OrkEngine3D.Mathematics.Vector3 sweep, out BoundingBox boundingBox)
        {
        ...
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 right;
            var direction = new OrkEngine3D.Mathematics.Vector3(transform.LinearTransform.M11, transform.LinearTransform.M21, transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out right);

            OrkEngine3D.Mathematics.Vector3 left;
            direction = new OrkEngine3D.Mathematics.Vector3(-transform.LinearTransform.M11, -transform.LinearTransform.M21, -transform.LinearTransform.M31);
            GetLocalExtremePoint(direction, out left);

            OrkEngine3D.Mathematics.Vector3 up;
            direction = new OrkEngine3D.Mathematics.Vector3(transform.LinearTransform.M12, transform.LinearTransform.M22, transform.LinearTransform.M32);
            ...
            OrkEngine3D.Mathematics.Vector3 backward;
            direction = new OrkEngine3D.Mathematics.Vector3(transform.LinearTransform.M13, transform.LinearTransform.M23, transform.LinearTransform.M33);
