...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class ConeShape : ConvexShape
    {
        ...
        public override void GetLocalExtremePointWithoutMargin(ref OrkEngine3D.Mathematics.Vector3 direction, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
            ...
            {
                extremePoint = new OrkEngine3D.Mathematics.Vector3(0, .75f * height, 0);
                return;
            }
            ...
            if (horizontalLengthSquared > Toolbox.Epsilon)
            {
                ...
                extremePoint = new OrkEngine3D.Mathematics.Vector3((float)(radOverSigma * direction.X), -.25f * height, (float)(radOverSigma * direction.Z));
            }
            else // It's pointing almost straight down...
                extremePoint = new OrkEngine3D.Mathematics.Vector3(0, -.25f * height, 0);
