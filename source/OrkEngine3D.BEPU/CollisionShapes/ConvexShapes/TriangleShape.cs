...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    {
        internal OrkEngine3D.Mathematics.Vector3 vA, vB, vC;

        ///<summary>
        /// Gets or sets the first vertex of the triangle shape.
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 VertexA
        {
            get
            {
                return vA;
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 VertexB
        {
            get
            {
                return vB;
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 VertexC
        {
            get
            {
                return vC;
        ...
        public TriangleShape(OrkEngine3D.Mathematics.Vector3 vA, OrkEngine3D.Mathematics.Vector3 vB, OrkEngine3D.Mathematics.Vector3 vC)
        {
            //Recenter.  Convexes should contain the origin.
            OrkEngine3D.Mathematics.Vector3 center = (vA + vB + vC) / 3;
            this.vA = vA - center;
            this.vB = vB - center;
            this.vC = vC - center;
        ...
        public TriangleShape(OrkEngine3D.Mathematics.Vector3 vA, OrkEngine3D.Mathematics.Vector3 vB, OrkEngine3D.Mathematics.Vector3 vC, out OrkEngine3D.Mathematics.Vector3 center)
        {
            //Recenter.  Convexes should contain the origin.
            center = (vA + vB + vC) / 3;
            this.vA = vA - center;
        ...
        public TriangleShape(OrkEngine3D.Mathematics.Vector3 vA, OrkEngine3D.Mathematics.Vector3 vB, OrkEngine3D.Mathematics.Vector3 vC, ConvexShapeDescription description)
        {
            //Recenter.  Convexes should contain the origin.
        ...
        {
            OrkEngine3D.Mathematics.Vector3 a, b, c;
        ...
        public static Matrix3x3 ComputeVolumeDistribution(OrkEngine3D.Mathematics.Vector3 vA, OrkEngine3D.Mathematics.Vector3 vB, OrkEngine3D.Mathematics.Vector3 vC)
        {
            OrkEngine3D.Mathematics.Vector3 center = (vA + vB + vC) * (1 / 3f);
            ...
            //localInertiaTensor += new OrkEngine3D.Mathematics.Matrix4x4(j * j + k * k, -j * j, -j * k, 0, -j * j, j * j + k * k, -j * k, 0, -j * k, -j * k, j * j + j * j, 0, 0, 0, 0, 0); //No mass per point.
        ...
        public OrkEngine3D.Mathematics.Vector3 GetLocalNormal()
        {
        ...
        public OrkEngine3D.Mathematics.Vector3 GetNormal(RigidTransform transform)
        {
            OrkEngine3D.Mathematics.Vector3 normal = GetLocalNormal();
