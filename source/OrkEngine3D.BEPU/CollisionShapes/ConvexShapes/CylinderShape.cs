...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class CylinderShape : ConvexShape
    {
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 positive;
        ...
        public override void GetLocalExtremePointWithoutMargin(ref OrkEngine3D.Mathematics.Vector3 direction, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
            ...
            if (horizontalLengthSquared > Toolbox.Epsilon)
            {
                ...
                extremePoint = new OrkEngine3D.Mathematics.Vector3(direction.X * multiplier, Math.Sign(direction.Y) * (halfHeight - collisionMargin), direction.Z * multiplier);
            }
            else
            {
                extremePoint = new OrkEngine3D.Mathematics.Vector3(0, Math.Sign(direction.Y) * (halfHeight - collisionMargin), 0);
            }
        ...
        upperTest:
            ...
            OrkEngine3D.Mathematics.Vector3 planeIntersection;
