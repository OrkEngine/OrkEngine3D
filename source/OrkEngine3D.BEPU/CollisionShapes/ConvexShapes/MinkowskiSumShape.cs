...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public struct OrientedConvexShapeEntry
    {
        ...
        public OrientedConvexShapeEntry(OrkEngine3D.Mathematics.Quaternion orientation, ConvexShape shape)
        {
    ...
    public class MinkowskiSumShape : ConvexShape
    {
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 LocalOffset
        {
            get
            {
                return localOffset;
        ...
        public MinkowskiSumShape(OrientedConvexShapeEntry firstShape, OrientedConvexShapeEntry secondShape, out OrkEngine3D.Mathematics.Vector3 center)
        ...
        /// <param name="shapeEntries">Entries composing the minkowski sum.</param>
        /// <param name="center">Center of the minkowski sum computed pre-recentering.</param>
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, out OrkEngine3D.Mathematics.Vector3 center)
            : this(shapeEntries)
        {
            center = -localOffset;
        }
        ...
        public MinkowskiSumShape(IList<OrientedConvexShapeEntry> shapeEntries, OrkEngine3D.Mathematics.Vector3 localOffset, ConvexShapeDescription description)
        {
            for (int i = 0; i < shapeEntries.Count; i++)
            {
                shapes.Add(shapeEntries[i]);
        ...
        public override void GetLocalExtremePointWithoutMargin(ref OrkEngine3D.Mathematics.Vector3 direction, out OrkEngine3D.Mathematics.Vector3 extremePoint)
        {
            ...
            for (int i = 1; i < shapes.WrappedList.Count; i++)
            {
                ...
                Vector3Ex.Add(ref extremePoint, ref temp, out extremePoint);
            }
            Vector3Ex.Add(ref extremePoint, ref localOffset, out extremePoint);
        }
