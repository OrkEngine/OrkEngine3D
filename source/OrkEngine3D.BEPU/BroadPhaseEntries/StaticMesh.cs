...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public class StaticMesh : StaticCollidable
    {
        ...
        public StaticMesh(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices)
        {
        ...
        public StaticMesh(OrkEngine3D.Mathematics.Vector3[] vertices, int[] indices, AffineTransform worldTransform)
        {
