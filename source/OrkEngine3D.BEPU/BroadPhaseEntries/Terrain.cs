    ...
    public class Terrain : StaticCollidable
    {
        ...
        public AffineTransform WorldTransform
        {
            ...
            set
            {
                ...
                if (Vector3Ex.Dot(normalTransform.Up, worldTransform.LinearTransform.Up) < 0)
                {
        ...
        public float Thickness
        {
            ...
            set
            {
                ...
                OrkEngine3D.Mathematics.Vector3 down = OrkEngine3D.Mathematics.Vector3.Normalize(worldTransform.LinearTransform.Down);
                OrkEngine3D.Mathematics.Vector3 thicknessOffset = down * (value - thickness);
        ...
        public override void UpdateBoundingBox()
        {
            ...
            OrkEngine3D.Mathematics.Vector3 thicknessOffset = OrkEngine3D.Mathematics.Vector3.Normalize(worldTransform.LinearTransform.Down) * thickness;
        ...
        public override bool ConvexCast(CollisionShapes.ConvexShapes.ConvexShape castShape, ref RigidTransform startingTransform, ref OrkEngine3D.Mathematics.Vector3 sweep, out RayHit hit)
        {
            hit = new RayHit();
        ...
        public void GetPosition(int i, int j, out OrkEngine3D.Mathematics.Vector3 position)
        {
