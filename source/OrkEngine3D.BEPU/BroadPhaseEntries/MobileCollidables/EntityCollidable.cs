    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        public RigidTransform WorldTransform
        {
            ...
            set
            {
                ...
                QuaternionEx.Conjugate(ref value.Orientation, out conjugate);
                OrkEngine3D.Mathematics.Vector3 worldOffset;
                QuaternionEx.Transform(ref localPosition, ref conjugate, out worldOffset);
                Vector3Ex.Subtract(ref value.Position, ref worldOffset, out value.Position);
        ...
        protected internal OrkEngine3D.Mathematics.Vector3 localPosition;
        ///<summary>
        ...
        ///</summary>
        public OrkEngine3D.Mathematics.Vector3 LocalPosition
        {
            get
            {
        ...
        public virtual void UpdateWorldTransform(ref OrkEngine3D.Mathematics.Vector3 position, ref OrkEngine3D.Mathematics.Quaternion orientation)
        {
