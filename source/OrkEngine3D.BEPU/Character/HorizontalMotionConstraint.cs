...
namespace BEPUphysics.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        OrkEngine3D.Mathematics.Vector2 movementDirection;
        /// <summary>
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector2 MovementDirection
        {
            ...
            set
            {
                if (movementDirection.X != value.X || movementDirection.Y != value.Y) //Floating point comparison is perfectly fine here. Any bitwise variation should go through.
                {
                    ...
                    {
                        movementDirection = new OrkEngine3D.Mathematics.Vector2();
                    }
                }
            }
        }
        ...
        internal OrkEngine3D.Mathematics.Vector3 movementDirection3d;
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 MovementDirection3d
        {
        ...
        public void UpdateMovementBasis(ref OrkEngine3D.Mathematics.Vector3 forward)
        {
            OrkEngine3D.Mathematics.Vector3 down = characterBody.orientationMatrix.Down;
            OrkEngine3D.Mathematics.Vector3 strafeDirection;
            OrkEngine3D.Mathematics.Vector3 horizontalForwardDirection = forward - down * Vector3Ex.Dot(down, forward);
            ...
            OrkEngine3D.Mathematics.Vector3 strafeComponent;
        ...
        OrkEngine3D.Mathematics.Vector3 linearJacobianA1;
        OrkEngine3D.Mathematics.Vector3 linearJacobianA2;
        OrkEngine3D.Mathematics.Vector3 linearJacobianB1;
        OrkEngine3D.Mathematics.Vector3 linearJacobianB2;
        OrkEngine3D.Mathematics.Vector3 angularJacobianB1;
        OrkEngine3D.Mathematics.Vector3 angularJacobianB2;

        OrkEngine3D.Mathematics.Vector2 accumulatedImpulse;
        OrkEngine3D.Mathematics.Vector2 targetVelocity;

        OrkEngine3D.Mathematics.Vector2 positionCorrectionBias;

        OrkEngine3D.Mathematics.Vector3 positionLocalOffset;
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 downDirection = characterBody.orientationMatrix.Down;
            ...
            if (MovementMode != MovementMode.Floating)
            {
                ...
                if (isTryingToMove)
                {
                    OrkEngine3D.Mathematics.Vector3 velocityDirection;
                    OrkEngine3D.Mathematics.Vector3 offVelocityDirection;
                    ...
                    OrkEngine3D.Mathematics.Vector3 lineStart = movementDirection3d;

                    OrkEngine3D.Mathematics.Vector3 lineEnd;
                ...
                else
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 toRemove;
                ...
                if (supportEntity != null)
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 supportToContact = supportData.Position - supportEntity.Position;
                ...
                else
                {
                    ...
                    angularJacobianB1 = new OrkEngine3D.Mathematics.Vector3();
                    angularJacobianB2 = new OrkEngine3D.Mathematics.Vector3();
                }
            }
            else
            {
                ...
                linearJacobianA2 = OrkEngine3D.Mathematics.Vector3.Cross(linearJacobianA1, characterBody.orientationMatrix.Down);
            ...
            if (!isTryingToMove && MovementMode == MovementMode.Traction && supportEntity != null)
            {
                ...
                {
                    OrkEngine3D.Mathematics.Vector3 targetPosition;
                    Vector3Ex.Multiply(ref downDirection, distanceToBottomOfCharacter, out targetPosition);
                    targetPosition += characterBody.Position;
                    OrkEngine3D.Mathematics.Vector3 worldSupportLocation = Matrix3x3.Transform(positionLocalOffset, supportEntity.OrientationMatrix) + supportEntity.Position;
                    OrkEngine3D.Mathematics.Vector3 error;
                    ...
                    if (error.LengthSquared() > PositionAnchorDistanceThreshold * PositionAnchorDistanceThreshold)
                    {
                        ...
                        positionLocalOffset = (positionLocalOffset + characterBody.Position) - supportEntity.Position;
                        positionLocalOffset = Matrix3x3.TransformTranspose(positionLocalOffset, supportEntity.OrientationMatrix);
                        positionCorrectionBias = new OrkEngine3D.Mathematics.Vector2();
                    }
                    else
                    {
        ...
        public override float SolveIteration()
        {
            ...
            OrkEngine3D.Mathematics.Vector2 relativeVelocity = RelativeVelocity;
            ...
            OrkEngine3D.Mathematics.Vector2 previousAccumulatedImpulse = accumulatedImpulse;
            if (MovementMode == MovementMode.Floating)
            {
...
#if !WINDOWS
                OrkEngine3D.Mathematics.Vector2 relativeVelocity = new OrkEngine3D.Mathematics.Vector2();
#else
                OrkEngine3D.Mathematics.Vector2 relativeVelocity;
#endif
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 RelativeWorldVelocity
        {
            get
            {
                OrkEngine3D.Mathematics.Vector3 bodyVelocity = characterBody.LinearVelocity;
                if (supportEntity != null)
