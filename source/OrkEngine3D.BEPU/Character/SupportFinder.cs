...
namespace BEPUphysics.Character
{
    ...
    public class SupportFinder
    {
        ...
        private void UpdateSupportData(ref OrkEngine3D.Mathematics.Vector3 down)
        {
        ...
        private void UpdateVerticalSupportData(ref OrkEngine3D.Mathematics.Vector3 down, ref OrkEngine3D.Mathematics.Vector3 movementDirection)
        {
            if (HasTraction)
            {
                if (tractionContacts.Count > 0)
        ...
        /// </summary>
        public void UpdateSupports(ref OrkEngine3D.Mathematics.Vector3 movementDirection)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 bodyPosition = characterBody.position;
