...
namespace BEPUphysics.Character
{
    ...
    public class SphereCharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        private OrkEngine3D.Mathematics.Vector3 down = new OrkEngine3D.Mathematics.Vector3(0, -1, 0);
        /// <summary>
        ...
        void ExpandBoundingBox()
        {
            if (Body.ActivityInformation.IsActive)
            {
                ...
                OrkEngine3D.Mathematics.Vector3 expansion = SupportFinder.MaximumAssistedDownStepHeight * down;
            ...
            try
            {
                ...
                if (tryToJump) //Jumping while crouching would be a bit silly.
                {
                    ...
                    if (SupportFinder.HasTraction)
                    {
                        ...
                        Vector3Ex.Dot(ref down, ref relativeVelocity, out currentDownVelocity);
