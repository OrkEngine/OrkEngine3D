...
namespace BEPUphysics.Character
{
    ...
    public class VerticalMotionConstraint : SolverUpdateable
    {
        ...
        OrkEngine3D.Mathematics.Vector3 linearJacobianA;
        OrkEngine3D.Mathematics.Vector3 linearJacobianB;
        OrkEngine3D.Mathematics.Vector3 angularJacobianB;
        ...
        public override void Update(float dt)
        {
            ...
            {
                OrkEngine3D.Mathematics.Vector3 offsetB = supportData.Position - supportEntity.Position;
                ...
                if (supportEntity.IsDynamic)
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 angularComponentB;
        ...
        public override void ExclusiveUpdate()
        {
...
#endif
            Vector3Ex.Multiply(ref linearJacobianA, accumulatedImpulse, out impulse);
            ...
            if (supportEntity != null && supportEntity.IsDynamic)
            {
                ...
                Vector3Ex.Multiply(ref angularJacobianB, accumulatedImpulse * supportForceFactor, out torque);
        ...
        public override float SolveIteration()
        {
            ...
            OrkEngine3D.Mathematics.Vector3 torque;
#endif
            Vector3Ex.Multiply(ref linearJacobianA, lambda, out impulse);
            ...
            if (supportEntity != null && supportEntity.IsDynamic)
            {
                ...
                Vector3Ex.Multiply(ref angularJacobianB, lambda * supportForceFactor, out torque);
        ...
        public float RelativeVelocity
        {
            get
            {
                ...
                Vector3Ex.Dot(ref linearJacobianA, ref characterBody.linearVelocity, out relativeVelocity);

                if (supportEntity != null)
                {
                    float supportVelocity;
                    Vector3Ex.Dot(ref linearJacobianB, ref supportEntity.linearVelocity, out supportVelocity);
                    relativeVelocity += supportVelocity;
                    Vector3Ex.Dot(ref angularJacobianB, ref supportEntity.angularVelocity, out supportVelocity);
                    relativeVelocity += supportVelocity;
