...
namespace BEPUphysics.Character
{
    ...
    public class StanceManager
    {
        ...
        private void PrepareQueryObject(EntityCollidable queryObject, ref OrkEngine3D.Mathematics.Vector3 position)
        {
        ...
        public bool UpdateStance(out OrkEngine3D.Mathematics.Vector3 newPosition)
        {
                ...
                else if (CurrentStance == Stance.Crouching && DesiredStance == Stance.Standing)
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                OrkEngine3D.Mathematics.Vector3 candidatePosition = currentPosition + currentOffset * down;
                                float hintOffset;
        ...
        CharacterContactPositionState TrySupportLocation(ref OrkEngine3D.Mathematics.Vector3 position, out float hintOffset,
