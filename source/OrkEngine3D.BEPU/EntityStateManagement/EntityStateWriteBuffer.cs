...
namespace BEPUphysics.EntityStateManagement
{
    ...
    public class EntityStateWriteBuffer : ProcessingStage
    {
        ...
        {
            [FieldOffset(0)]
            internal OrkEngine3D.Mathematics.Quaternion orientationQuaternion;
            [FieldOffset(0)]
            internal OrkEngine3D.Mathematics.Vector3 vector;
            [FieldOffset(16)]
        ...
        public void EnqueuePosition(Entity entity, ref OrkEngine3D.Mathematics.Vector3 newPosition)
        {
        ...
        public void EnqueueOrientation(Entity entity, ref OrkEngine3D.Mathematics.Quaternion newOrientationQuaternion)
        {
        ...
        public void EnqueueLinearVelocity(Entity entity, ref OrkEngine3D.Mathematics.Vector3 newLinearVelocity)
        {
        ...
        public void EnqueueAngularVelocity(Entity entity, ref OrkEngine3D.Mathematics.Vector3 newAngularVelocity)
        {
