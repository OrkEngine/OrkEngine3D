...
namespace BEPUphysics.Constraints.SingleEntity
{
    ...
    public class SingleEntityAngularMotor : SingleEntityConstraint, I3DImpulseConstraintWithError
    {
...
#endif
            OrkEngine3D.Mathematics.Vector3 aVel = entity.angularVelocity;
        ...
        public override void Update(float dt)
        {
            ...
            {
                OrkEngine3D.Mathematics.Quaternion currentRelativeOrientation;
                var worldTransform = basis.WorldTransform;
                QuaternionEx.CreateFromRotationMatrix(ref worldTransform, out currentRelativeOrientation);
                ...
                QuaternionEx.Conjugate(ref currentRelativeOrientation, out errorOrientation);
