...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class EllipseSwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private OrkEngine3D.Mathematics.Vector3 localTwistAxisB;
        private float maximumAngleX;
        private float maximumAngleY;
        private OrkEngine3D.Mathematics.Vector3 worldTwistAxisB;
        ...
        public EllipseSwingLimit(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 twistAxis, float maximumAngleX, float maximumAngleY)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalTwistAxisB
        {
        ...
        /// The transformed twist axis will be used to determine the angles around entity A's basis axes.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 TwistAxisB
        {
        ...
        public void SetupJointTransforms(OrkEngine3D.Mathematics.Vector3 twistAxis)
        {
            ...
            Vector3Ex.Cross(ref twistAxis, ref Toolbox.UpVector, out xAxis);
            float length = xAxis.LengthSquared();
            if (length < Toolbox.Epsilon)
            {
                Vector3Ex.Cross(ref twistAxis, ref Toolbox.RightVector, out xAxis);
            }

            OrkEngine3D.Mathematics.Vector3 yAxis;
            Vector3Ex.Cross(ref twistAxis, ref xAxis, out yAxis);
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Quaternion relativeRotation;
...
#if !WINDOWS
            OrkEngine3D.Mathematics.Vector3 axisAngle = new OrkEngine3D.Mathematics.Vector3();
#else
            OrkEngine3D.Mathematics.Vector3 axisAngle;
#endif
...
#if !WINDOWS
            OrkEngine3D.Mathematics.Vector2 tangent = new OrkEngine3D.Mathematics.Vector2();
#else
            OrkEngine3D.Mathematics.Vector2 tangent;
#endif
            ...
            OrkEngine3D.Mathematics.Vector3 sphereTangentX, sphereTangentY;
