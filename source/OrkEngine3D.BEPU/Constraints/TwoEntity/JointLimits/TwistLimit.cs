...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class TwistLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public TwistLimit(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 axisA, OrkEngine3D.Mathematics.Vector3 axisB, float minimumAngle, float maximumAngle)
        {
        ...
        public void SetupJointTransforms(OrkEngine3D.Mathematics.Vector3 worldTwistAxisA, OrkEngine3D.Mathematics.Vector3 worldTwistAxisB)
        {
            worldTwistAxisA.Normalize();
            worldTwistAxisB.Normalize();

            OrkEngine3D.Mathematics.Vector3 worldXAxis;
            ...
            //Complete A's basis.
            OrkEngine3D.Mathematics.Vector3 worldYAxis;
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Quaternion rotation;
            QuaternionEx.GetQuaternionBetweenNormalizedVectors(ref basisB.primaryAxis, ref basisA.primaryAxis, out rotation);
            ...
            QuaternionEx.Transform(ref basisB.xAxis, ref rotation, out twistMeasureAxis);

            //By dotting the measurement vector with a 2d plane's axes, we can get a local X and Y value.
            float y, x;
            Vector3Ex.Dot(ref twistMeasureAxis, ref basisA.yAxis, out y);
            Vector3Ex.Dot(ref twistMeasureAxis, ref basisA.xAxis, out x);
            ...
            if (error > 0)
            {
                Vector3Ex.Add(ref basisA.primaryAxis, ref basisB.primaryAxis, out jacobianB);
            ...
            else
            {
                ...
                Vector3Ex.Add(ref basisA.primaryAxis, ref basisB.primaryAxis, out jacobianA);
