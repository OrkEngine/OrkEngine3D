...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class DistanceLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public DistanceLimit(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 anchorA, OrkEngine3D.Mathematics.Vector3 anchorB, float minimumLength, float maximumLength)
        {
