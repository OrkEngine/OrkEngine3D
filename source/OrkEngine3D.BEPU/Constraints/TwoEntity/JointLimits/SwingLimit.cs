...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class SwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private OrkEngine3D.Mathematics.Vector3 hingeAxis;
        ...
        public SwingLimit(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 axisA, OrkEngine3D.Mathematics.Vector3 axisB, float maximumAngle)
        {
