...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class LinearAxisLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public LinearAxisLimit(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 anchorA, OrkEngine3D.Mathematics.Vector3 anchorB, OrkEngine3D.Mathematics.Vector3 axis, float minimum, float maximum)
        {
