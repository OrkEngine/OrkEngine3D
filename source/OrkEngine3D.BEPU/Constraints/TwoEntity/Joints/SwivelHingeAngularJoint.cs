...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class SwivelHingeAngularJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private float error;
        private OrkEngine3D.Mathematics.Vector3 localHingeAxis;
        private OrkEngine3D.Mathematics.Vector3 localTwistAxis;
        private OrkEngine3D.Mathematics.Vector3 worldHingeAxis;
        private OrkEngine3D.Mathematics.Vector3 worldTwistAxis;
        ...
        /// The connected entities will be able to rotate around this axis relative to each other.</param>
        public SwivelHingeAngularJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 worldHingeAxis, OrkEngine3D.Mathematics.Vector3 worldTwistAxis)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalHingeAxis
        {
            get { return localHingeAxis; }
            set
            {
                localHingeAxis = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalTwistAxis
        {
            get { return localTwistAxis; }
            set
            {
                localTwistAxis = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldHingeAxis
        {
            get { return worldHingeAxis; }
            set
            {
                worldHingeAxis = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                OrkEngine3D.Mathematics.Quaternion conjugate;
                QuaternionEx.Conjugate(ref connectionA.orientation, out conjugate);
                QuaternionEx.Transform(ref worldHingeAxis, ref conjugate, out localHingeAxis);
            }
        }
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldTwistAxis
        {
            get { return worldTwistAxis; }
            set
            {
                worldTwistAxis = OrkEngine3D.Mathematics.Vector3.Normalize(value);
                OrkEngine3D.Mathematics.Quaternion conjugate;
                QuaternionEx.Conjugate(ref connectionB.orientation, out conjugate);
                QuaternionEx.Transform(ref worldTwistAxis, ref conjugate, out localTwistAxis);
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            if (length > Toolbox.Epsilon)
                ...
                jacobianA = new OrkEngine3D.Mathematics.Vector3();
