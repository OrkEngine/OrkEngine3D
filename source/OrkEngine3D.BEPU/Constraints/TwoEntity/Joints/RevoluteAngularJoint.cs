...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class RevoluteAngularJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        private OrkEngine3D.Mathematics.Vector3 localAxisA, localAxisB;
        private OrkEngine3D.Mathematics.Vector3 localConstrainedAxis1, localConstrainedAxis2; //Not a and b because they are both based on a...
        private OrkEngine3D.Mathematics.Vector2 error;
        private OrkEngine3D.Mathematics.Vector3 worldAxisA, worldAxisB;
        private OrkEngine3D.Mathematics.Vector3 worldConstrainedAxis1, worldConstrainedAxis2;
        ...
        public RevoluteAngularJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 freeAxis)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalFreeAxisA
        {
            get { return localAxisA; }
            set
            {
                localAxisA = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalFreeAxisB
        {
            get { return localAxisB; }
            set
            {
                localAxisB = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// Updates the internal restricted axes.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldFreeAxisA
        {
            get { return worldAxisA; }
            set
            {
                worldAxisA = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// This does not change the other connection's free axis.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldFreeAxisB
        {
            get { return worldAxisB; }
            set
            {
                worldAxisB = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        {
            localConstrainedAxis1 = OrkEngine3D.Mathematics.Vector3.Cross(Vector3Ex.Up, localAxisA);
            if (localConstrainedAxis1.LengthSquared() < .001f)
            {
                localConstrainedAxis1 = OrkEngine3D.Mathematics.Vector3.Cross(Vector3Ex.Right, localAxisA);
            }
            localConstrainedAxis2 = OrkEngine3D.Mathematics.Vector3.Cross(localAxisA, localConstrainedAxis1);
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 axis1I, axis2I;
        ...
        public override float SolveIteration()
        {
            ...
            OrkEngine3D.Mathematics.Vector2 softnessImpulse;
