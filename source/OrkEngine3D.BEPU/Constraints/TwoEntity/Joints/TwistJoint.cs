...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    {
        private OrkEngine3D.Mathematics.Vector3 aLocalAxisY, aLocalAxisZ;
        private float accumulatedImpulse;
        private OrkEngine3D.Mathematics.Vector3 bLocalAxisY;
        private float biasVelocity;
        private OrkEngine3D.Mathematics.Vector3 jacobianA, jacobianB;
        private float error;
        private OrkEngine3D.Mathematics.Vector3 localAxisA;
        private OrkEngine3D.Mathematics.Vector3 localAxisB;
        private OrkEngine3D.Mathematics.Vector3 worldAxisA;
        private OrkEngine3D.Mathematics.Vector3 worldAxisB;
        ...
        public TwistJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 axisA, OrkEngine3D.Mathematics.Vector3 axisB)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalAxisA
        {
        ...
        /// Gets or sets the axis attached to the first connected entity in its local space.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalAxisB
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldAxisA
        {
        ...
        /// Gets or sets the axis attached to the first connected entity in world space.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 WorldAxisB
        {
        ...
        {
            OrkEngine3D.Mathematics.Vector3 aAxisY, aAxisZ;
            OrkEngine3D.Mathematics.Vector3 bAxisY;
            Matrix3x3.Transform(ref localAxisA, ref connectionA.orientationMatrix, out worldAxisA);
            ...
            OrkEngine3D.Mathematics.Quaternion rotation;
            ...
            OrkEngine3D.Mathematics.Vector3 twistMeasureAxis;
