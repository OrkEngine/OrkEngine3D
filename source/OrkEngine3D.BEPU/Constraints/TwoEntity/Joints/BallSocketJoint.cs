...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class BallSocketJoint : Joint, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public BallSocketJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 anchorLocation)
        {
        ...
        public override void Update(float dt)
        {
            ...
            //Mass OrkEngine3D.Mathematics.Matrix4x4
            Matrix3x3 k;
        ...
        public override void ExclusiveUpdate()
        {
...
#else
            OrkEngine3D.Mathematics.Vector3 linear;
#endif
            ...
            if (connectionB.isDynamic)
            {
                ...
                OrkEngine3D.Mathematics.Vector3 tbImpulse;
