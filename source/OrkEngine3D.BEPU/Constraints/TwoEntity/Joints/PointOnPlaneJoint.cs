...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private OrkEngine3D.Mathematics.Vector3 localPlaneAnchor;
        private OrkEngine3D.Mathematics.Vector3 localPlaneNormal;
        private OrkEngine3D.Mathematics.Vector3 localPointAnchor;

        private OrkEngine3D.Mathematics.Vector3 worldPlaneAnchor;
        private OrkEngine3D.Mathematics.Vector3 worldPlaneNormal;
        private OrkEngine3D.Mathematics.Vector3 worldPointAnchor;
        private float negativeEffectiveMass;
        private OrkEngine3D.Mathematics.Vector3 rA;
        private OrkEngine3D.Mathematics.Vector3 rAcrossN;
        private OrkEngine3D.Mathematics.Vector3 rB;
        private OrkEngine3D.Mathematics.Vector3 rBcrossN;
        ...
        public PointOnPlaneJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 planeAnchor, OrkEngine3D.Mathematics.Vector3 normal, OrkEngine3D.Mathematics.Vector3 pointAnchor)
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalPlaneAnchor
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalPlaneNormal
        {
            get { return localPlaneNormal; }
            set
            {
                localPlaneNormal = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 LocalPointAnchor
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 PlaneAnchor
        {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 PlaneNormal
        {
            get { return worldPlaneNormal; }
            set
            {
                worldPlaneNormal = OrkEngine3D.Mathematics.Vector3.Normalize(value);
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 PointAnchor
        {
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 closestPointOnPlane;
            ...
            {
                OrkEngine3D.Mathematics.Vector3 IrACrossN, IrBCrossN;
            ...
            {
                OrkEngine3D.Mathematics.Vector3 IrACrossN;
                Matrix3x3.Transform(ref rAcrossN, ref connectionA.inertiaTensorInverse, out IrACrossN);
                float angularA;
                Vector3Ex.Dot(ref rAcrossN, ref IrACrossN, out angularA);
            ...
            {
                OrkEngine3D.Mathematics.Vector3 IrBCrossN;
                Matrix3x3.Transform(ref rBcrossN, ref connectionB.inertiaTensorInverse, out IrBCrossN);
                float angularB;
                Vector3Ex.Dot(ref rBcrossN, ref IrBCrossN, out angularB);
