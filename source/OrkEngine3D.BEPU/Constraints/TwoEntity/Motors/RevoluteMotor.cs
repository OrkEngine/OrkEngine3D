...
namespace BEPUphysics.Constraints.TwoEntity.Motors
{
    ...
    public class RevoluteMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public RevoluteMotor(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 motorizedAxis)
        {
        ...
        public void SetupJointTransforms(OrkEngine3D.Mathematics.Vector3 motorizedAxis)
        {
            ...
            Vector3Ex.Cross(ref motorizedAxis, ref Toolbox.UpVector, out xAxis);
            float length = xAxis.LengthSquared();
            if (length < Toolbox.Epsilon)
            {
                Vector3Ex.Cross(ref motorizedAxis, ref Toolbox.RightVector, out xAxis);
            }
        ...
        public override void Update(float dt)
        {
            ...
            if (settings.mode == MotorMode.Servomechanism)
            {
                ...
                Vector3Ex.Cross(ref basis.primaryAxis, ref basis.xAxis, out yAxis);
