...
namespace BEPUphysics.Constraints.TwoEntity.Motors
{
    ...
    {
        internal OrkEngine3D.Mathematics.Vector3 goal;
        ...
        /// Gets or sets the goal position of the servo.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 Goal
        {
            get { return goal; }
            set
            {
    ...
    {
        internal OrkEngine3D.Mathematics.Quaternion goal;
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Quaternion Goal
        {
            get { return goal; }
            set
            {
    ...
    {
        internal OrkEngine3D.Mathematics.Vector3 goalVelocity;
        ...
        /// Gets or sets the goal position of the servo.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 GoalVelocity
        {
            get { return goalVelocity; }
            set
            {
