...
namespace BEPUphysics.Constraints
{
    ...
    public interface I1DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobian);

        /// <summary>
        /// Gets the angular jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Angular jacobian entry for the second connected entity.</param>
        void GetAngularJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the first connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the first connected entity.</param>
        void GetLinearJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobian);

        /// <summary>
        /// Gets the linear jacobian entry for the second connected entity.
        /// </summary>
        /// <param name="jacobian">Linear jacobian entry for the second connected entity.</param>
        void GetLinearJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobian);
    ...
    public interface I2DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY);
        ...
        void GetAngularJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY);
        ...
        void GetLinearJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY);
        ...
        void GetLinearJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY);
    ...
    public interface I3DJacobianConstraint
    {
        ...
        void GetAngularJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY, out OrkEngine3D.Mathematics.Vector3 jacobianZ);
        ...
        void GetAngularJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY, out OrkEngine3D.Mathematics.Vector3 jacobianZ);
        ...
        void GetLinearJacobianA(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY, out OrkEngine3D.Mathematics.Vector3 jacobianZ);
        ...
        void GetLinearJacobianB(out OrkEngine3D.Mathematics.Vector3 jacobianX, out OrkEngine3D.Mathematics.Vector3 jacobianY, out OrkEngine3D.Mathematics.Vector3 jacobianZ);
