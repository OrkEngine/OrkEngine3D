...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class PrismaticJoint : SolverGroup
    {
        ...
        public PrismaticJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 lineAnchor, OrkEngine3D.Mathematics.Vector3 lineDirection, OrkEngine3D.Mathematics.Vector3 pointAnchor)
        {
            if (connectionA == null)
