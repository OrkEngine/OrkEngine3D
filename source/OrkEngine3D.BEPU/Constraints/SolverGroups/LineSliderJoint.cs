...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class LineSliderJoint : SolverGroup
    {
        ...
        public LineSliderJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 lineAnchor, OrkEngine3D.Mathematics.Vector3 lineDirection, OrkEngine3D.Mathematics.Vector3 pointAnchor)
        {
            if (connectionA == null)
