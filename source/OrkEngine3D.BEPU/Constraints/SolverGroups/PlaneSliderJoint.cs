...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class PlaneSliderJoint : SolverGroup
    {
        ...
        public PlaneSliderJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 planeAnchor, OrkEngine3D.Mathematics.Vector3 planeNormal, OrkEngine3D.Mathematics.Vector3 xAxis, OrkEngine3D.Mathematics.Vector3 yAxis, OrkEngine3D.Mathematics.Vector3 pointAnchor)
        {
            if (connectionA == null)
