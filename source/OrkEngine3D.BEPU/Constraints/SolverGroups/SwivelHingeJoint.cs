...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class SwivelHingeJoint : SolverGroup
    {
        ...
        public SwivelHingeJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 anchor, OrkEngine3D.Mathematics.Vector3 hingeAxis)
        {
            if (connectionA == null)
            ...
            OrkEngine3D.Mathematics.Vector3 baseAxis = anchor - connectionA.position;
            ...
            if (baseAxis.LengthSquared() < Toolbox.BigEpsilon)
            {
                ...
                baseAxis = OrkEngine3D.Mathematics.Vector3.Cross(hingeAxis, Vector3Ex.Up);
                if (baseAxis.LengthSquared() < Toolbox.BigEpsilon)
                {
                    baseAxis = OrkEngine3D.Mathematics.Vector3.Cross(hingeAxis, Vector3Ex.Right);
                }
            }
