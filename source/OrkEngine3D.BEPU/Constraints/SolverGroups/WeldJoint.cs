...
namespace BEPUphysics.Constraints.SolverGroups
{
    ...
    public class WeldJoint : SolverGroup
    {
        ...
        private static OrkEngine3D.Mathematics.Vector3 GetAnchorGuess(Entity connectionA, Entity connectionB)
        {
            var anchor = new OrkEngine3D.Mathematics.Vector3();
            if (connectionA != null)
        ...
        public WeldJoint(Entity connectionA, Entity connectionB, OrkEngine3D.Mathematics.Vector3 anchor)
        {
            if (connectionA == null)
                connectionA = TwoEntityConstraint.WorldEntity;
            if (connectionB == null)
