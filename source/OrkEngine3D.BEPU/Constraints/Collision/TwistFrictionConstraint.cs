...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class TwistFrictionConstraint : SolverUpdateable
    {
...
#else
            OrkEngine3D.Mathematics.Vector3 angular;
#endif
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 relativeSlidingVelocity = contactManifoldConstraint.SlidingFriction.relativeVelocity;
            ...
            OrkEngine3D.Mathematics.Vector3 contactOffset;
            for (int i = 0; i < contactCount; i++)
            {
