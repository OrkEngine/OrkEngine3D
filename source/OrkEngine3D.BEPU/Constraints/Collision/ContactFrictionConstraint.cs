...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class ContactFrictionConstraint : SolverUpdateable
    {
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 FrictionDirection
        {
            get { return new OrkEngine3D.Mathematics.Vector3(linearAX, linearAY, linearAZ); }
        }
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 velocityA = new OrkEngine3D.Mathematics.Vector3(), velocityB = new OrkEngine3D.Mathematics.Vector3();
            OrkEngine3D.Mathematics.Vector3 ra = penetrationConstraint.ra, rb = penetrationConstraint.rb;
            if (entityA != null)
            {
            ...
            OrkEngine3D.Mathematics.Vector3 normal = penetrationConstraint.contact.Normal;
