...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class SlidingFrictionTwoAxis : SolverUpdateable
    {
        ...
        internal OrkEngine3D.Mathematics.Vector2 accumulatedImpulse;
        ...
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 FrictionDirectionX
        {
            get { return new OrkEngine3D.Mathematics.Vector3(linearA.M11, linearA.M12, linearA.M13); }
        }
        ...
        /// This is one of two directions that are perpendicular to each other and the normal of a collision between two entities.
        /// </summary>
        public OrkEngine3D.Mathematics.Vector3 FrictionDirectionY
        {
            get { return new OrkEngine3D.Mathematics.Vector3(linearA.M21, linearA.M22, linearA.M23); }
        }
        ...
        public OrkEngine3D.Mathematics.Vector2 RelativeVelocity
        {
            get
            {
                ...
                //Explicit version:
                //OrkEngine3D.Mathematics.Vector2 dot;
                ...
                //OrkEngine3D.Mathematics.Vector3 wara, wbrb;
                //Vector3Ex.Cross(ref parentA.myInternalAngularVelocity, ref Ra, out wara);
                //Vector3Ex.Cross(ref parentB.myInternalAngularVelocity, ref Rb, out wbrb);
        ...
        public override float SolveIteration()
        {
            ...
            OrkEngine3D.Mathematics.Vector2 lambda = RelativeVelocity;
            ...
            //Apply impulse
#if !WINDOWS
            OrkEngine3D.Mathematics.Vector3 linear = new OrkEngine3D.Mathematics.Vector3();
            OrkEngine3D.Mathematics.Vector3 angular = new OrkEngine3D.Mathematics.Vector3();
#else
            OrkEngine3D.Mathematics.Vector3 linear, angular;
#endif
        ...
        internal OrkEngine3D.Mathematics.Vector3 manifoldCenter, relativeVelocity;
        ...
        public override void Update(float dt)
        {
            ...
            OrkEngine3D.Mathematics.Vector3 velocityA, velocityB;
            if (entityA != null)
            {
                ...
                velocityA = new OrkEngine3D.Mathematics.Vector3();
            if (entityB != null)
            {
                ...
                velocityB = new OrkEngine3D.Mathematics.Vector3();
            Vector3Ex.Subtract(ref velocityA, ref velocityB, out relativeVelocity);

            //Get rid of the normal velocity.
            OrkEngine3D.Mathematics.Vector3 normal = contactManifoldConstraint.penetrationConstraints.Elements[0].contact.Normal;
            ...
            else
            {
                ...
                if (!(linearA.M11 != 0 || linearA.M12 != 0 || linearA.M13 != 0))
                {
                    ...
                    OrkEngine3D.Mathematics.Vector3 axis1;
        ...
        {
            accumulatedImpulse = new OrkEngine3D.Mathematics.Vector2();
